...
import { TELE_BOX_STATE as TELE_BOX_STATE$1, ReadonlyTeleBox, TeleBoxRect, TeleBoxColorScheme, TeleBoxManager, TeleBoxManagerUpdateConfig, TeleBoxConfig, TeleBoxState } from '@netless/telebox-insider';
...
type PublicEvent = {
    ...
    boxStateChange: `${TELE_BOX_STATE$1}`;
...
declare class AttributesDelegate {
    ...
    getMaximized(): any;
    getMinimized(): any;
    getBoxsStatus(): Record<string, TELE_BOX_STATE$1> | undefined;
    setBoxsStatus(boxsStatus: Record<string, TELE_BOX_STATE$1> | undefined): void;
    getBoxStatus(id: string): TELE_BOX_STATE$1 | undefined;
    setBoxStatus(id: string, status: TELE_BOX_STATE$1 | undefined): void;
