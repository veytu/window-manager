...
declare class AttributesDelegate {
    ...
    getLastNotMinimizedBoxStatus(id: string): TELE_BOX_NOT_MINIMIZED_STATE | undefined;
...
declare class LaserPointerManager {
  ...
  */
     ...
     * @returns 偏移量
     */
    private _getViewOffset;
    /**
     * 获取视图的div元素
     * @param view 视图
     * @returns div元素
     */
    private _getViewDivElement;
    /**
     * 显示坐标点
     * @param view 视图
     * @param point 坐标点
     */
    private _showPointIcon;
}
