...
class dT {
  ...
  ensureState(n) {
    return this.setState(
      pb(n).reduce((o, l) => (Lb(this._state, l) || (o[l] = n[l]), o), {})
    );
  }
  setState(n) {
    if (this._destroyed) {
...
class KN {
  constructor(n) {
    this.windowManger = n, this.appProxies = /* @__PURE__ */ new Map(), this.appStatus = /* @__PURE__ */ new Map(), this.store = YN, this.isReplay = this.windowManger.isReplay, this.mainViewScenesLength = 0, this.callbacksNode = null, this.appCreateQueue = new dN(), this.sideEffectManager = new kd(), this.sceneState = null, this.rootDirRemoving = !1, this.onRemoveScenes = async (o) => {
      ...
      const o = this.store.getMainViewScenePath(), l = hb(o), h = Ad(this.displayer)[l];
      if (h.length) {
...
var mb = 0, DM = typeof window < "u" && window.requestAnimationFrame !== void 0 ? function(r) {
  ...
  var n = Date.now(), o = Math.max(0, 16.7 - (n - mb));
  mb = n + o, setTimeout(function() {
    return r(mb);
  }, o);
}, ak = function(r) {
...
function Vk(r, n, o, l, h, m) {
  ...
  return (S !== void 0 || C !== void 0 || Y.transform) && (h.style.transformOrigin = jk(n, S !== void 0 ? S : vT, C !== void 0 ? C : vT)), w !== void 0 && (h.x = w), g !== void 0 && (h.y = g), o !== void 0 && I !== void 0 && (h[m ? "stroke-dashoffset" : "strokeDashoffset"] = wb(-U, o), h[m ? "stroke-dasharray" : "strokeDasharray"] = wb(I, o) + " " + wb(z, o)), h;
}
function Uk(r, n, o) {
  o === void 0 && (o = !0);
  var l = WM(), h = gS(FM);
...
var e_ = Object.defineProperty, bb = (typeof require < "u" && require, (r, n, o) => (((l, h, m) => {
  h in l ? e_(l, h, { enumerable: !0, configurable: !0, writable: !0, value: m }) : l[h] = m;
})(r, typeof n != "symbol" ? n + "" : n, o), o));
class cp {
  constructor(n, o) {
    bb(this, "_value"), bb(this, "_beforeDestroys"), bb(this, "_subscribers"), this._value = n, o && (this.compare = o);
  }
  get value() {
    return this._value;
  }
...
class l_ {
  constructor({
    ...
    const Ue = ce(he, ws), Re = ce(be, ws), Qe = ce(o);
...
function I_(r, n) {
  const o = r.$$;
  o.fragment !== null && (vg(o.on_destroy), o.fragment && o.fragment.d(n), o.on_destroy = o.fragment = null, o.ctx = []);
}
function A_(r, n) {
...
function ET(r) {
  ...
  return {
    ...
    m(I, A) {
      gg(I, n, A), vo(n, o), S && S.m(o, null), vo(o, l), vo(o, h), vo(h, m), vo(o, w), C && C.m(o, null);
    },
    p(I, A) {
...
function IT(r) {
  ...
  return {
    c() {
      n = ul("img"), Dn(n, "class", "netless-window-manager-cursor-selector-avatar"), Dn(n, "style", r[20]()), lg(n.src, o = r[8]) || Dn(n, "src", o), Dn(n, "alt", "avatar");
    },
    m(l, h) {
      gg(l, n, h);
    },
    p(l, h) {
      h & 256 && !lg(n.src, o = l[8]) && Dn(n, "src", o);
    },
    d(l) {
      l && dp(n);
    }
...
function N_(r) {
  ...
  return {
    ...
    m(C, I) {
      gg(C, n, I), S && S.m(n, null), vo(n, o), vo(n, l), vo(l, h);
    },
    p(C, [I]) {
...
class X_ {
  constructor(n) {
    this.ctx = n, this.reactors = /* @__PURE__ */ new Map(), this.disposers = /* @__PURE__ */ new Map(), this.onPhaseChanged = async (o) => {
      var l, h;
      o === ll.Reconnecting && this.ctx.emitter.emit("startReconnect"), o === ll.Connected && this.phase === ll.Reconnecting && ((l = this.room) != null && l.isWritable ? (h = this.room) == null || h.dispatchMagixEvent(fb, {}) : (await CM(500), this.onReconnected())), this.phase = o;
  ...
  destroy() {
    var n, o;
    (n = this.room) == null || n.callbacks.off("onPhaseChanged", this.onPhaseChanged), (o = this.room) == null || o.removeMagixEventListener(fb, this.onReconnected), this.releaseDisposers();
  }
}
const J_ = (r, n) => {
  if (sS(r))
...
var _u = function(r) {
  ...
  var o = getComputedStyle(r), l = SS(r) && r.ownerSVGElement && r.getBBox(), h = !EP && o.boxSizing === "border-box", m = MP.test(o.writingMode || ""), w = !l && OT.test(o.overflowY || ""), g = !l && OT.test(o.overflowX || ""), S = l ? 0 : ys(o.paddingTop), C = l ? 0 : ys(o.paddingRight), I = l ? 0 : ys(o.paddingBottom), A = l ? 0 : ys(o.paddingLeft), z = l ? 0 : ys(o.borderTopWidth), F = l ? 0 : ys(o.borderRightWidth), U = l ? 0 : ys(o.borderBottomWidth), q = l ? 0 : ys(o.borderLeftWidth), Y = A + C, fe = S + I, se = q + F, Z = z + U, le = g ? r.offsetHeight - Z - r.clientHeight : 0, oe = w ? r.offsetWidth - se - r.clientWidth : 0, ke = h ? Y + se : 0, Fe = h ? fe + Z : 0, ze = l ? l.width : ys(o.width) - ke - oe, G = l ? l.height : ys(o.height) - Fe - le, he = ze + Y + oe + se, be = G + fe + le + Z, ie = _u({
...
const dl = typeof window < "u", cE = dl && !("onscroll" in window) || typeof navigator < "u" && /(gle|ing|ro)bot|crawl|spider/i.test(navigator.userAgent), dE = dl && "IntersectionObserver" in window, fE = dl && "classList" in document.createElement("p"), hE = dl && window.devicePixelRatio > 1, $P = {
  ...
  r.setAttribute(l, o);
}, hp = (r) => er(r, SE), Ou = (r, n) => YP(r, SE, n), wg = (r) => Ou(r, null), ES = (r) => hp(r) === null, GP = (r) => hp(r) === TS, XP = (r) => hp(r) === MS, IS = (r) => hp(r) === wE, JP = [TS, gE, yE, MS], qP = (r) => JP.indexOf(hp(r)) >= 0, fl = (r, n, o, l) => {
  if (!!r) {
    if (l !== void 0) {
      r(n, o, l);
      return;
  ...
  _d(r, n.class_applied), Ou(r, yE), o && (n.unobserve_completed && bg(r, n), fl(n.callback_applied, r, o));
}, NE = (r, n, o) => {
  ...
  ME(r, (o) => {
    Rd(o, Sg), cl(o, go, er(o, n.data_src));
  ...
  ez(r), AS(o, -1), iz(o), Ss(r, n.class_loading), n.unobserve_completed && bg(r, o);
}, xz = (r, n, o, l) => {
  const h = IS(n);
  ...
  !o.cancel_on_exit || !GP(r) || r.tagName === "IMG" && (Kb(r), Iz(r), zE(r), Ss(r, o.class_loading), AS(l, -1), wg(r), fl(o.callback_cancel, r, n, l));
}, Oz = (r, n, o, l) => {
  const h = qP(r);
  Ou(r, ZP), _d(r, o.class_entered), Ss(r, o.class_exited), nz(r, o, l), fl(o.callback_enter, r, n, l), !h && kS(r, o, l);
}, Lz = (r, n, o, l) => {
...
function xO() {
  return lM || (lM = 1, process.env.NODE_ENV !== "production" && function() {
    var r = hl.exports, n = Cg(), o = FE(), l = HE(), h = SO(), m = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
`).replace(jc, "");
      ...
      for (var p in u)
        if (!!u.hasOwnProperty(p)) {
          ...
          if (p === dr)
            ...
            p === qs || p === ki || p === Ho || (He.hasOwnProperty(p) ? y != null && (typeof y != "function" && Ja(p, y), Ln(s, p)) : y != null && M(t, p, y, d));
        }
    }
    function _i(e, t, s, u) {
    ...
    function US() {
      if (ih)
        return ih;
      var e, t = Gg, s = t.length, u, d = HS(), p = d.length;
    ...
    function LI(e, t, s, u) {
      var d, p;
      if (Xg ? d = zI(e) : Zc ? GS(e, s) && (d = so.compositionEnd) : OI(e, s) && (d = so.compositionStart), !d)
        return null;
    ...
    var dx = "\u269B", CA = "\u26D4", yi = typeof performance < "u" && typeof performance.mark == "function" && typeof performance.clearMarks == "function" && typeof performance.measure == "function" && typeof performance.clearMeasures == "function", lu = null, rs = null, uu = null, Im = !1, Am = !1, ty = !1, fh = 0, as = 0, Rm = /* @__PURE__ */ new Set(), ny = function(e) {
      ...
      var s = Te(e.type) || "Unknown", u = e._debugID, d = e.alternate !== null, p = ry(s, d, t);
      if (Im && Rm.has(p))
        return !1;
      Rm.add(p);
      var y = iy(p, u);
      ...
      var s = Te(e.type) || "Unknown", u = e._debugID, d = e.alternate !== null, p = ry(s, d, t), y = iy(p, u);
      MA(y);
    }, Dm = function(e, t, s) {
    ...
    function Oi(e, t, s) {
      oo++, sy[oo] = e.current, _m[oo] = s, e.current = t;
    }
    var oy;
    oy = {};
    var mr = {};
    ...
    function Om(e) {
      {
        ...
        return ly = lo.current, Oi(lo, s, e), Oi(ls, ls.current, e), !0;
      }
    }
    function Ax(e, t, s) {
      {
    ...
    function Qx(e, t) {
      ...
      if (t === fs || t === du)
        return hh;
      var s = fu(t) - fu(e);
      return s <= 0 ? Li : s <= Wx + Fx ? Yo : s <= vh + vy ? ha : hh;
    }
    var pa = {
...
Learn more about this warning here: https://fb.me/react-legacy-context%s`, d, p);
    ...
    function wy(e, t, s) {
      {
        ...
        nd !== null && (nd.has(e) || u !== null && nd.has(u)) && (k = !0), k && (e._debugNeedsRemount = !0), (k || N) && Zr(e, Ct), d !== null && !k && wy(d, t, s), p !== null && wy(p, t, s);
      }
    }
    var GA = function(e, t) {
      {
    ...
    function by(e, t, s) {
      {
        ...
        var E = !1;
        b !== null && t.has(b) && (E = !0), E ? XA(e, s) : u !== null && by(u, t, s), d !== null && by(d, t, s);
      }
    }
    function XA(e, t) {
      {
    ...
    function qx(e, t) {
      ...
      Oi(Sy, s._currentValue, e), s._currentValue = t, s._currentRenderer !== void 0 && s._currentRenderer !== null && s._currentRenderer !== xy && g("Detected multiple renderers concurrently rendering the same context provider. This is currently unsupported."), s._currentRenderer = xy;
    }
    function Cy(e) {
      var t = Sy.current;
      zi(Sy, e);
    ...
    function ad(e, t) {
      ...
      if (s !== null) {
        ...
        u !== null && (s.expirationTime >= t && Aw(), s.firstContext = null);
      }
    }
    function Bn(e, t) {
    ...
    var Ay = {}, r1 = Array.isArray, a0 = new r.Component().refs, Ry, Dy, Ny, ky, _y, s0, Xm, Py, zy, Oy;
    {
      ...
      Xm = function(e, t) {
        ...
        if (t === void 0) {
          ...
          _y.has(s) || (_y.add(s), g("%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.", s));
        }
...
https://fb.me/react-unsafe-component-lifecycles`, Ke, nt, K !== null ? `
  ...
  ` + we : ""));
    ...
    function By(e, t, s, u) {
      a1(e, t, s);
      var d = e.stateNode;
      d.props = s, d.state = e.memoizedState, d.refs = a0, Ey(e);
      var p = t.contextType;
      if (typeof p == "object" && p !== null)
        d.context = Bn(p);
      else {
...
Incoming: %s`, ae, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function dd(e, t, s, u, d, p) {
      ...
      if (t.expirationTime === qo) {
        ...
        do {
          ...
          b += 1, Jy = !1, wi = null, li = null, t.updateQueue = null, Ko = -1, Ie.current = A0, y = s(u, d);
    ...
    function aw(e, t, s, u) {
      ...
      Tn.effectTag |= e, d.memoizedState = iw(ud | t, s, void 0, p);
    }
    function sw(e, t, s, u) {
      ...
      Tn.effectTag |= e, d.memoizedState = iw(ud | t, s, y, p);
    }
    function cv(e, t) {
    ...
    function fw(e) {
      var t = Nh(!1), s = t[0], u = t[1], d = pv(dw.bind(null, u, e), [u, e]);
      return [d, s];
    }
    function x0(e) {
      var t = ov(), s = t[0], u = t[1], d = md(dw.bind(null, u, e), [u, e]);
      return [d, s];
    }
    function C0(e) {
      var t = lv(), s = t[0], u = t[1], d = md(dw.bind(null, u, e), [u, e]);
      return [d, s];
    }
    function T0(e, t, s) {
    ...
    }, M0 = null, E0 = null, I0 = null, A0 = null, hs = null, ga = null, gv = null;
    {
      ...
      M0 = {
        ...
        useImperativeHandle: function(e, t, s) {
          return ae = "useImperativeHandle", en(), Dh(s), lw(e, t, s);
        },
        ...
        useImperativeHandle: function(e, t, s) {
          return ae = "useImperativeHandle", Pe(), lw(e, t, s);
        },
        useLayoutEffect: function(e, t) {
        ...
        useImperativeHandle: function(e, t, s) {
          return ae = "useImperativeHandle", ht(), en(), lw(e, t, s);
        },
        useLayoutEffect: function(e, t) {
    ...
    function yr(e, t, s, u) {
      e === null ? t.child = Fy(t, null, s, u) : t.child = sd(t, e.child, s, u);
    }
    function C1(e, t, s, u) {
    ...
    function L0(e, t, s, u, d, p) {
      if (e === null) {
        ...
        var N = tb(s.type, null, u, null, t.mode, p);
    ...
    function V0(e, t, s, u, d) {
      ...
      var b = t.stateNode, E;
      b === null ? (e !== null && (e.alternate = null, t.alternate = null, t.effectTag |= Cn), c0(t, s, u), By(t, s, u, d), E = !0) : e === null ? E = o1(t, s, u, d) : E = l1(e, t, s, u, d);
      var N = Tw(e, t, s, E, y, d);
      {
        var k = t.stateNode;
    ...
    function A1(e, t, s) {
      ...
      return b ? y = null : p !== null && T(u, p) && (t.effectTag |= Ri), j0(e, t), t.mode & td && s !== fs && R(u, d) ? (Gw(fs), t.expirationTime = t.childExpirationTime = fs, null) : (yr(e, t, y, s), t.child);
    }
    function R1(e, t) {
    ...
    function N1(e, t, s, u, d) {
      ...
      var p;
      return us(s) ? (p = !0, Om(t)) : p = !1, ad(t, d), c0(t, s, u), By(t, s, u, d), Tw(null, t, s, !0, p, d);
    }
    function k1(e, t, s, u) {
      e !== null && (e.alternate = null, t.alternate = null, t.effectTag |= Cn);
      ...
      if (t.effectTag |= lr, typeof b == "object" && b !== null && typeof b.render == "function" && b.$$typeof === void 0) {
        ...
        var k = !1;
        us(s) ? (k = !0, Om(t)) : k = !1, t.memoizedState = b.state !== null && b.state !== void 0 ? b.state : null, Ey(t);
        var J = s.getDerivedStateFromProps;
        return typeof J == "function" && Jm(t, s, J, d), u0(t, b), By(t, s, d, u), Tw(null, t, s, !0, k, u);
      } else
        return t.tag = Oe, t.mode & yn && t.memoizedState !== null && (b = dd(null, t, s, d, p, u)), yr(null, t, b, u), Mw(t, s), t.child;
    }
    function Mw(e, t) {
      {
...
Check the render method of \`` + u + "`.");
          ...
          p && (d = p.fileName + ":" + p.lineNumber), Sw[d] || (Sw[d] = !0, g("Function components cannot be given refs. Attempts to access this ref will fail. Did you mean to use React.forwardRef()?%s", s));
        }
    ...
    function H0(e, t, s) {
      ...
      if (b || _1(p, e) ? (y = !0, t.effectTag &= ~Vt) : (e === null || e.memoizedState !== null) && d.fallback !== void 0 && d.unstable_avoidThisFallback !== !0 && (p = f1(p, Yy)), p = Rh(p), mu(t, p), e === null)
        if (d.fallback !== void 0 && mw(t), y) {
          ...
          var me = d.children;
          return t.memoizedState = null, t.child = Fy(t, null, me, s);
        }
      else {
        ...
        if (d !== p || Pm() || t.type !== e.type)
          ...
          switch (el = !1, t.tag) {
            case Se:
              ...
              break;
            case Re:
              if (m0(t), t.mode & td && s !== fs && R(t.type, p))
    ...
    G0 = function(e, t, s, u) {
      ...
      if (p !== u) {
        var y = t.stateNode, b = Qy(), E = x(y, s, p, u, d, b);
              ...
              if (!It)
                for (var Ht = t.child; Ht !== null; ) {
                  ...
                  if (At !== null) {
                    ...
                    return zt !== null && (t.updateQueue = zt, t.effectTag |= xt), pe.lastEffect === null && (t.firstEffect = null), t.lastEffect = pe.lastEffect, c1(t, s), mu(t, Gy(va.current, Ah)), t.child;
                  }
                  Ht = Ht.sibling;
                }
            }
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` + $n(s));
    ...
    function vR(e, t) {
      ...
      GR(e, t), RA();
      var u = ed();
      if (t === Ct ? (rt & Lw) !== In && (rt & (wr | ps)) === In ? (nl(s, t), Ww(s)) : (br(s), nl(s, t), rt === In && cs()) : (br(s), nl(s, t)), (rt & hC) !== In && (u === Yo || u === Li))
        if (Su === null)
    ...
    function TC(e) {
      ...
      px(e), Co(e);
      var s;
      return (e.mode & ds) !== oi ? (pw(e), s = Qw(t, e, ui), wv(e, !0)) : s = Qw(t, e, ui), rr(), e.memoizedProps = e.pendingProps, s === null && (s = MC(e)), fC.current = null, s;
    }
    function MC(e) {
      We = e;
      do {
    ...
    function PR(e, t) {
      ...
      if (K !== Ae) {
        ...
        gd = null;
      if (J || zC(e, u), K === Ct ? e === Hw ? Bh++ : (Bh = 0, Hw = e) : Bh = 0, aD(s.stateNode, u), br(e), Dv) {
        Dv = !1;
        var Ke = Vw;
        throw Vw = null, Ke;
      }
    ...
    function BR() {
      ...
      return zv(u), zC(e, t), rt = s, cs(), Nv = yd === null ? 0 : Nv + 1, !0;
    }
    function EC(e) {
      ...
      Qw = function(e, t, s) {
        ...
        try {
          ...
          if (p !== null && typeof p == "object" && typeof p.then == "function")
            throw p;
          if ($m(), y0(), K0(t), LC(t, u), t.mode & ds && pw(t), se(null, Z0, null, e, t, s), oe()) {
            var d = ke();
            throw d;
          } else
            throw p;
...
Check the render method of \`` + k + "`.");
    ...
    function nb(e, t, s) {
      var u = null;
      u = e._owner;
      var d = e.type, p = e.key, y = e.props, b = tb(d, p, y, u, t, s);
    ...
    function CD(e, t) {
      {
        ...
        if (u.mode & yn) {
          ...
          ob[d] || (ob[d] = !0, s.mode & yn ? g("%s is deprecated in StrictMode. %s was passed an instance of %s which is inside StrictMode. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://fb.me/react-strict-mode-find-node%s", t, t, d, $n(u)) : g("%s is deprecated in StrictMode. %s was passed an instance of %s which renders StrictMode children. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://fb.me/react-strict-mode-find-node%s", t, t, d, $n(u)));
        }
        return u.stateNode;
      }
    }
...
const al = {
  ...
  constructor(r, n) {
    this.manager = r, this.appManager = n, this.magixEventMap = /* @__PURE__ */ new Map(), this.cssList = [], this.allowAppliances = ["clicker"], this.bridgeDisposer = yM, this.rootRect = null, this.sideEffectManager = new kd(), this.execListenIframe = Ta((o) => {
      this.listenIframe(o);
...
[data-cursor-uid="${h}"] { display: flex }`;
  ...
  _updateMainViewWrapperSize(r) {
    ...
    n({ width: (o == null ? void 0 : o.width) * l, height: (o == null ? void 0 : o.height) * l }), this.moveCamera({
      scale: l,
      animationMode: ag.Immediately
  ...
  _setScale(r, n) {
    ...
    if (!nT(l))
      return !1;
    let h = l;
    return h < 1 && (h = 1), n || et.emit("onScaleChange", { appId: o, scale: h }), this.safeUpdateAttributes(["scale"], { ...this.getAttributesValue(["scale"]), [o]: h }), o == Xv && this._updateMainViewWrapperSize(h), setTimeout(() => {
      var m;
      (m = this.scrollerManager) == null || m.moveToCenter(o);
    }), !0;
  }
  getScale() {
