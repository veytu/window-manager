...
class tL {
  ...
  dispatchScrollEvent({ x: n, y: s }) {
    clearTimeout(this.scrollFinished), this.scrollFinished = setTimeout(() => {
      var m;
      const l = this._scrollingElement.scrollTop;
      Math.abs(l - this.lastScrollTop) < 1 && ((m = this.manager.room) == null || m.dispatchMagixEvent(fg, { appId: this.appId, x: n, y: s }));
    }, 200), this.lastScrollTop = this._scrollingElement.scrollTop;
  }
  scroll() {
