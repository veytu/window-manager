...
class tL {
  ...
  dispatchScrollEvent({ x: n, y: s }) {
    clearTimeout(this.scrollFinished), this.scrollFinished = setTimeout(() => {
      ...
      l === this.lastScrollTop ? (h = this.manager.room) == null || h.dispatchMagixEvent(fg, { appId: this.appId, x: n, y: s }) : this.lastScrollTop = l;
    }, 200);
  }
  scroll() {
