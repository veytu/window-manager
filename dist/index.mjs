...
import { debounce as xs, isEqual as tg, omit as nS, isObject as xa, has as kb, get as yn, size as UD, mapValues as VD, noop as dM, pick as HD, isNumber as Pb, isEmpty as Gh, isInteger as WD, orderBy as FD, isFunction as xd, isString as jv, isNull as $D } from "lodash";
import { ScenePathType as Gv, UpdateEventKind as fM, listenUpdated as ng, unlistenUpdated as iS, reaction as lg, autorun as Ss, toJS as QD, listenDisposed as ZD, unlistenDisposed as YD, ViewMode as sl, AnimationMode as _b, isPlayer as rS, isRoom as Du, WhiteVersion as GD, ApplianceNames as Dn, RoomPhase as Nu, PlayerPhase as KC, InvisiblePlugin as XD } from "white-web-sdk";
...
class aS {
  constructor(i, o, c, h) {
    ...
    this.params = i, this.manager = o, this.boxManager = this.manager.boxManager, this.appProxies = this.manager.appProxies, this.viewManager = this.manager.viewManager, this.store = this.manager.store, this.status = "normal", this.getAppInitState = (y) => {
      ...
      let ee = { maximized: z, minimized: F, zIndex: $ };
      return S && (ee = { ...ee, id: y, x: S.x, y: S.y }), C === y && (ee = { ...ee, focus: !0 }), A && (ee = { ...ee, width: A.width, height: A.height }), I && (ee = { ...ee, sceneIndex: I }), ee;
...
(function(r) {
  ...
  g.prototype.eventNames = function() {
    ...
    if (!this._events[ee])
      return !1;
    var q = this._events[ee], fe = arguments.length, se, Z;
    if (q.fn) {
    ...
    if ($.fn)
      ...
      for (var ee = 0, q = [], fe = $.length; ee < fe; ee++)
        ($[ee].fn !== A || z && !$[ee].once || I && $[ee].context !== I) && q.push($[ee]);
...
var qv = {
  ...
  return function(g) {
    ...
    function z($, ee) {
      ...
      var q = C[$];
      C[$] = ee, C[$] !== q && (A.indexOf($) === -1 && A.push($), I || (I = !0, KN.render(F.render)));
    }
    var F = {
      get: function($, ee) {
        ee === void 0 && (ee = !1);
        var q = !ee && y && !h.has($) && C[$] !== void 0;
        return q ? C[$] : i($, S);
      },
      set: function($, ee) {
        if (typeof $ == "string")
...
}, RM = /* @__PURE__ */ new Map(), fS = /* @__PURE__ */ new Map(), DM = ["Webkit", "Moz", "O", "ms", ""], uk = DM.length, ck = typeof document < "u", hb, NM = function(r, i) {
...
function Tk(r, i, o, c, h, m, y, g) {
  ...
  var S = !0, C = !1, A = !1;
  for (var I in r) {
    var z = r[I], F = pS(I), $ = bk(z, F);
    hS(I) ? (C = !0, c[I] = $, m.push(I), S && (F.default && z !== F.default || !F.default && z !== 0) && (S = !1)) : yk(I) ? (h[I] = $, A = !0) : (!Sk.has(I) || !_M($)) && (o[kM(I, y)] = $);
  }
...
function Nk(r, i, o, c, h, m) {
  ...
  var y = r.attrX, g = r.attrY, S = r.originX, C = r.originY, A = r.pathLength, I = r.pathSpacing, z = I === void 0 ? 1 : I, F = r.pathOffset, $ = F === void 0 ? 0 : F, ee = oS(r, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]), q = c(ee);
  for (var fe in q)
    if (fe === "transform")
  ...
  return (S !== void 0 || C !== void 0 || q.transform) && (h.style.transformOrigin = Dk(i, S !== void 0 ? S : fT, C !== void 0 ? C : fT)), y !== void 0 && (h.x = y), g !== void 0 && (h.y = g), o !== void 0 && A !== void 0 && (h[m ? "stroke-dashoffset" : "strokeDashoffset"] = pb(-$, o), h[m ? "stroke-dasharray" : "strokeDasharray"] = pb(A, o) + " " + pb(z, o)), h;
}
function kk(r, i, o) {
  o === void 0 && (o = !0);
  var c = OM(), h = mS(LM);
...
class Kk {
  constructor({
    ...
    const Ye = ue(ee), re = ue(q), D = ue(fe), B = ue(se), K = ue(ce);
    K.reaction((Ne, st, He) => {
    ...
    const Ge = _e(
      [ge, it],
      ([Ne, st]) => Ne ? dn.Minimized : st ? dn.Maximized : dn.Normal
    );
    Ge.reaction((Ne, st, He) => {
  ...
  render(i) {
    ...
    const o = (I, z, F, $ = Xk) => this._renderSideEffect.add(() => {
      const ee = this.wrapClassName(F);
      return z.subscribe((q) => {
        I.classList.toggle(ee, $(q));
      });
    });
    o(this.$box, this._readonly$, "readonly"), o(this.$box, this._draggable$, "no-drag", Vv), o(this.$box, this._resizable$, "no-resize", Vv), o(this.$box, this._focus$, "blur", Vv), o(this.$box, this._darkMode$, "color-scheme-dark"), o(this.$box, this._darkMode$, "color-scheme-light", Vv), this._renderSideEffect.add(() => {
      ...
      return this._state$.subscribe(($) => {
        this.$box.classList.toggle(I, $ === dn.Minimized), $ === dn.Maximized ? (this._renderSideEffect.flush(F), this.$box.classList.toggle(z, !0)) : this._renderSideEffect.setTimeout(
          () => {
    ...
    }), this._maximized$.reaction((I) => {
      A.classList.toggle(this.wrapClassName("footer-hide"), I);
  ...
  _renderResizeHandlers() {
    const i = document.createElement("div");
    i.className = this.wrapClassName("resize-handles"), Object.values(ws).forEach((ee) => {
      const q = document.createElement("div");
      q.className = this.wrapClassName(ee) + " " + this.wrapClassName("resize-handle"), q.dataset.teleBoxHandle = ee, i.appendChild(q);
    ...
    const z = (ee) => {
      ...
      I = void 0, h && (Ed(ee), this.$box.classList.toggle(c, !1), this._sideEffect.flush(o), h.remove());
    }, $ = (ee) => {
      var q;
      if (this.readonly || ee.button != null && ee.button !== 0 || !this.draggable || I || this.state !== dn.Normal)
        return;
      const fe = ee.target;
      if ((q = fe.dataset) != null && q.teleBoxHandle) {
        Ed(ee), m = this.x, y = this.y, g = this.width, S = this.height, { pageX: C, pageY: A } = vT(ee), I = fe.dataset.teleBoxHandle, h || (h = document.createElement("div"));
  ...
  renderTitles() {
    ...
    return S ? (h = this.wrp$) == null || h.replaceChild(this.$titles, S) : (c = this.wrp$) == null || c.appendChild(this.$titles), tP(() => {
      ...
      if (!this.$titles || !this.wrp$ || !this.root)
        return;
      const I = (C = this.wrp$) == null ? void 0 : C.getBoundingClientRect(), z = (A = this.root) == null ? void 0 : A.getBoundingClientRect(), F = nP(this.$titles), $ = I.top - z.top > F.height, ee = I.x - z.x > F.width / 2 - I.width / 2, q = -F.height - 10;
      let fe = -(F.width / 2 - I.width / 2);
      if (!$) {
        const se = I.top > 60 ? I.top : 60;
        this.$titles.style.height = `${se}px`;
      }
      ee || (fe = -(I.x - z.x - 4)), this.$titles.style.top = `${q}px`, this.$titles.style.left = `${fe}px`;
    }), this.$titles;
  }
  destroy() {
...
class aP {
  constructor({
    ...
    ee.reaction((Y, he, Ee) => {
      ...
      this.maxTitleBar.setState(ie.length > 0 ? dn.Maximized : dn.Normal), this.maxTitleBar.setMaximizedBoxes(Y), Ee || this.events.emit(Gn.Maximized, Y);
    });
    const q = A(
    ...
    Z.subscribe((Y) => {
      Y && (Y.setVisible(this.minimizedBoxes$.value.length > 0), Y.setReadonly(ee.value), Y.setDarkMode(this._darkMode$.value), this._sideEffect.add(() => (Y.onClick = (he) => {
        ee.value || this.setMinimizedBoxes(
          Vh(
    ...
    oe.subscribe((Y, he, Ee) => {
      ...
      this.maxTitleBar.setState(ue.length > 0 ? dn.Maximized : dn.Normal), this.maxTitleBar.setMinimizedBoxes(Y);
      const Qe = Y.length > 0;
    ...
    }), ee.subscribe((Y) => this.maxTitleBar.setReadonly(Y)), this._darkMode$.subscribe((Y) => {
...
function bT(r) {
  ...
  return {
    ...
    p(A, I) {
      A[18] ? S ? S.p(A, I) : (S = ST(A), S.c(), S.m(o, c)) : S && (S.d(1), S = null), I & 2 && WM(m, A[1]), A[19] ? C ? C.p(A, I) : (C = xT(A), C.c(), C.m(o, null)) : C && (C.d(1), C = null), I & 512 && Rn(o, "class", A[9]), I & 8 && Si(o, "background-color", A[3]), I & 1024 && Si(o, "color", A[10]), I & 4096 && Si(o, "opacity", A[12]), I & 98304 && g !== (g = "netless-window-manager-cursor-name " + A[16] + " " + A[15]) && Rn(i, "class", g);
    },
    d(A) {
      A && cp(i), S && S.d(), C && C.d();
    }
...
function CP(r, i, o) {
  let c, h, m, y, g, S, C, A, { uid: I } = i, { cursorName: z } = i, { tagName: F } = i, { backgroundColor: $ } = i, { appliance: ee } = i, { x: q } = i, { y: fe } = i, { src: se } = i, { visible: Z } = i, { avatar: ce } = i, { theme: oe } = i, { color: Oe } = i, { cursorTagBackgroundColor: $e } = i, { opacity: je } = i, { pencilEraserSize: Y } = i, { custom: he } = i;
  ...
  return r.$$set = (ie) => {
    "uid" in ie && o(0, I = ie.uid), "cursorName" in ie && o(1, z = ie.cursorName), "tagName" in ie && o(2, F = ie.tagName), "backgroundColor" in ie && o(3, $ = ie.backgroundColor), "appliance" in ie && o(4, ee = ie.appliance), "x" in ie && o(5, q = ie.x), "y" in ie && o(6, fe = ie.y), "src" in ie && o(7, se = ie.src), "visible" in ie && o(21, Z = ie.visible), "avatar" in ie && o(8, ce = ie.avatar), "theme" in ie && o(9, oe = ie.theme), "color" in ie && o(10, Oe = ie.color), "cursorTagBackgroundColor" in ie && o(11, $e = ie.cursorTagBackgroundColor), "opacity" in ie && o(12, je = ie.opacity), "pencilEraserSize" in ie && o(22, Y = ie.pencilEraserSize), "custom" in ie && o(13, he = ie.custom);
  }, r.$$.update = () => {
    r.$$.dirty & 2 && (c = !Gh(z)), r.$$.dirty & 4 && o(19, h = !Gh(F)), r.$$.dirty & 256 && o(18, m = !Gh(ce)), r.$$.dirty & 2097152 && o(17, y = Z ? "" : "none"), r.$$.dirty & 16 && o(14, g = ee === Dn.laserPointer), r.$$.dirty & 16400 && o(23, S = g || ee === Dn.pencilEraser), r.$$.dirty & 8388608 && o(16, C = S ? "netless-window-manager-laserPointer-pencilEraser-offset" : ""), r.$$.dirty & 4194304 && o(15, A = Y === 3 ? "netless-window-manager-pencilEraser-3-offset" : "");
  }, [
    I,
    z,
    F,
...
const ul = typeof window < "u", iE = ul && !("onscroll" in window) || typeof navigator < "u" && /(gle|ing|ro)bot|crawl|spider/i.test(navigator.userAgent), rE = ul && "IntersectionObserver" in window, aE = ul && "classList" in document.createElement("p"), sE = ul && window.devicePixelRatio > 1, O_ = {
  ...
  r.setAttribute(c, o);
}, fp = (r) => er(r, pE), Ou = (r, i) => j_(r, pE, i), pg = (r) => Ou(r, null), TS = (r) => fp(r) === null, U_ = (r) => fp(r) === xS, V_ = (r) => fp(r) === CS, MS = (r) => fp(r) === fE, H_ = [xS, cE, dE, CS], W_ = (r) => H_.indexOf(fp(r)) >= 0, cl = (r, i, o, c) => {
  if (!!r) {
    if (c !== void 0) {
      r(i, o, c);
      return;
  ...
  gE(r).forEach(i);
}, vg = [go], wE = [go, lE], op = [go, bS, SS], bE = [uE], gg = (r) => !!r[dp], SE = (r) => r[dp], xE = (r) => delete r[dp], Rd = (r, i) => {
  if (gg(r))
    return;
  const o = {};
  i.forEach((c) => {
  ...
  !o.cancel_on_exit || !U_(r) || r.tagName === "IMG" && (Jb(r), yz(r), AE(r), bs(r, o.class_loading), ES(c, -1), pg(r), cl(o.callback_cancel, r, i, c));
}, Iz = (r, i, o, c) => {
  const h = W_(r);
...
}, DE = (r) => Array.prototype.slice.call(r), sg = (r) => r.container.querySelectorAll(r.elements_selector), Lz = (r) => DE(r).filter(TS), Bz = (r) => V_(r), jz = (r) => DE(r).filter(Bz), VT = (r, i) => Lz(r || sg(i)), Uz = (r, i) => {
  jz(sg(r)).forEach((c) => {
  ...
  constructor({
    ...
    this.sideEffect = new hg(), this.userScrolling = !1, this.onNewPageIndex = ($) => {
      ...
      for (const [oe, Oe] of this.pages.entries()) {
        ...
        ie.src = Ee, await new Promise((Ve) => ie.onload = Ve), ee.drawImage(ie, 0, 0);
        const ct = $.toDataURL("image/jpeg", 0.6);
        ee.clearRect(0, 0, $e, je);
        const _e = {
          centerX: $e / 2,
          centerY: je / 2 + oe * je,
          scale: 1
        }, ue = this.context.manager.windowManger;
        ue._appliancePlugin ? await ue._appliancePlugin.screenshotToCanvasAsync(ee, q, $e, je, _e) : this.whiteboardView.screenshotToCanvas(ee, q, $e, je, _e);
        const Qe = $.toDataURL("image/png");
        Z.addImage(ct, "JPEG", 0, 0, $e, je, "", "FAST"), Z.addImage(Qe, "PNG", 0, 0, $e, je, "", "FAST"), ee.clearRect(0, 0, $e, je), Math.ceil((oe + 1) / this.pages.length * 100) < 100 && this.reportProgress(Math.ceil((oe + 1) / this.pages.length * 100), null);
      }
...
function iO() {
  ...
  function $(D) {
    for (var B = "https://reactjs.org/docs/error-decoder.html?invariant=" + D, K = 1; K < arguments.length; K++)
      B += "&args[]=" + encodeURIComponent(arguments[K]);
  ...
  function fe(D, B, K) {
    this.props = D, this.context = B, this.refs = q, this.updater = K || ee;
  }
  ...
  var ie = /\/+/g, ct = [];
  function _e(D, B, K, xe) {
    if (ct.length) {
      var ge = ct.pop();
      return ge.result = D, ge.keyPrefix = B, ge.func = K, ge.context = xe, ge.count = 0, ge;
    }
    return { result: D, keyPrefix: B, func: K, context: xe, count: 0 };
  }
  function ue(D) {
    D.result = null, D.keyPrefix = null, D.func = null, D.context = null, D.count = 0, 10 > ct.length && ct.push(D);
  }
  function Qe(D, B, K, xe) {
    var ge = typeof D;
    ...
    if (it = 0, B = B === "" ? "." : B + ":", Array.isArray(D))
      ...
      for (D = Le.call(D), Ge = 0; !(ge = D.next()).done; )
        ge = ge.value, Le = B + Ve(ge, Ge++), it += Qe(ge, Le, K, xe);
    else if (ge === "object")
      throw K = "" + D, Error($(31, K === "[object Object]" ? "object with keys {" + Object.keys(D).join(", ") + "}" : K, ""));
    return it;
  }
  function be(D, B, K) {
    return D == null ? 0 : Qe(D, "", B, K);
  }
  function Ve(D, B) {
  ...
  function Fe(D, B, K) {
    ...
    D = D.func.call(D.context, B, D.count++), Array.isArray(D) ? Tt(D, xe, K, function(it) {
      return it;
    }) : D != null && (he(D) && (D = Y(D, ge + (!D.key || B && B.key === D.key ? "" : ("" + D.key).replace(ie, "$&/") + "/") + K)), xe.push(D));
  }
  function Tt(D, B, K, xe, ge) {
    var it = "";
    K != null && (it = ("" + K).replace(ie, "$&/") + "/"), B = _e(B, it, xe, ge), be(D, Fe, B), ue(B);
  }
  var Bt = { current: null };
  function Ye() {
    var D = Bt.current;
  ...
  return Ot.Children = { map: function(D, B, K) {
    if (D == null)
      return D;
    var xe = [];
    return Tt(D, xe, null, B, K), xe;
  }, forEach: function(D, B, K) {
    if (D == null)
      return D;
    B = _e(null, null, B, K), be(D, Re, B), ue(B);
  }, count: function(D) {
    ...
    if (!he(D))
      throw Error($(143));
    return D;
  } }, Ot.Component = fe, Ot.Fragment = h, Ot.Profiler = y, Ot.PureComponent = Z, Ot.StrictMode = m, Ot.Suspense = A, Ot.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = re, Ot.cloneElement = function(D, B, K) {
    if (D == null)
      throw Error($(267, D));
  ...
  }, Ot.useImperativeHandle = function(D, B, K) {
    return Ye().useImperativeHandle(D, B, K);
  }, Ot.useLayoutEffect = function(D, B) {
    return Ye().useLayoutEffect(D, B);
  }, Ot.useMemo = function(D, B) {
    return Ye().useMemo(D, B);
  }, Ot.useReducer = function(D, B, K) {
    return Ye().useReducer(D, B, K);
...
function sO() {
  return YT || (YT = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    Object.freeze(xe);
    function ge(M, P, V) {
      this.props = M, this.context = P, this.refs = xe, this.updater = V || K;
    }
    ...
    var wn = Object.prototype.hasOwnProperty, Ft = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Mr(M, P, V) {
      ...
      if (P != null) {
        ...
        for (G in P)
          wn.call(P, G) && !Ft.hasOwnProperty(G) && (Se[G] = P[G]);
      }
    ...
    function Gr(M, P, V) {
      ...
      if (P != null) {
        ...
        for (G in P)
          wn.call(P, G) && !Ft.hasOwnProperty(G) && (P[G] === void 0 && Sn !== void 0 ? Se[G] = Sn[G] : Se[G] = P[G]);
      }
    ...
    function Da(M) {
      {
        ...
        if (typeof P == "function")
          G = P.propTypes;
        else if (typeof P == "object" && (P.$$typeof === z || P.$$typeof === ee))
          G = P.propTypes;
        else
          return;
  ...
  return GT || (GT = 1, function(r) {
    ...
    function Y(re) {
      ...
      if (D !== void 0) {
        ...
        if (B !== D) {
          re[0] = B;
          e:
            for (var K = 0, xe = re.length; K < xe; ) {
              var ge = 2 * (K + 1) - 1, it = re[ge], Ge = ge + 1, Le = re[Ge];
              if (it !== void 0 && 0 > he(it, B))
                Le !== void 0 && 0 > he(Le, it) ? (re[K] = Le, re[Ge] = B, K = Ge) : (re[K] = it, re[ge] = B, K = ge);
              else if (Le !== void 0 && 0 > he(Le, B))
                re[K] = Le, re[Ge] = B, K = Ge;
              else
                break e;
            }
        }
    ...
    r.unstable_IdlePriority = 5, r.unstable_ImmediatePriority = 1, r.unstable_LowPriority = 4, r.unstable_NormalPriority = 3, r.unstable_Profiling = null, r.unstable_UserBlockingPriority = 2, r.unstable_cancelCallback = function(re) {
      ...
      if (typeof B == "object" && B !== null) {
        var xe = B.delay;
        xe = typeof xe == "number" && 0 < xe ? K + xe : K, B = typeof B.timeout == "number" ? B.timeout : Bt(re);
      } else
        B = Bt(re), xe = K;
      return B = xe + B, re = { id: ct++, callback: D, priorityLevel: re, startTime: xe, expirationTime: B, sortIndex: -1 }, xe > K ? (re.sortIndex = xe, $e(ie, re), je(Ee) === null && re === je(ie) && (Ve ? c() : Ve = !0, o(Fe, xe - K))) : (re.sortIndex = B, $e(Ee, re), be || Qe || (be = !0, i(Tt))), re;
  ...
  return XT || (XT = 1, function(r) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      if (typeof window > "u" || typeof MessageChannel != "function") {
        ...
        var z = window.performance, F = window.Date, $ = window.setTimeout, ee = window.clearTimeout;
        if (typeof console < "u") {
      ...
      var be = 0, Ve = 1, Re = 2, Fe = 3, Tt = 4, Bt = 5, Ye = 0, re = 0, D = 4, B = typeof SharedArrayBuffer == "function" ? new SharedArrayBuffer(D * Int32Array.BYTES_PER_ELEMENT) : typeof ArrayBuffer == "function" ? new ArrayBuffer(D * Int32Array.BYTES_PER_ELEMENT) : null, K = B !== null ? new Int32Array(B) : [], xe = 0, ge = 1, it = 2, Ge = 3;
      K[xe] = be, K[Ge] = 0, K[ge] = 0;
      var Le = 131072, dt = 524288, gt = 0, Zt = null, Mt = null, wn = 0, Ft = 1, Ui = 2, Ci = 3, Jn = 4, Ne = 5, st = 6, He = 7, jt = 8;
      function bn(ne) {
        if (Mt !== null) {
          var de = wn;
      ...
      function Bn(ne, de) {
        K[Ge]++, Mt !== null && bn([Ft, de * 1e3, ne.id, ne.priorityLevel]);
      }
      function Gr(ne, de) {
        K[xe] = be, K[ge] = 0, K[Ge]--, Mt !== null && bn([Ui, de * 1e3, ne.id]);
      }
      function Vi(ne, de) {
        K[Ge]--, Mt !== null && bn([Jn, de * 1e3, ne.id]);
      }
      function Ta(ne, de) {
        K[xe] = be, K[ge] = 0, K[Ge]--, Mt !== null && bn([Ci, de * 1e3, ne.id]);
      }
      function Ma(ne, de) {
        Ye++, K[xe] = ne.priorityLevel, K[ge] = ne.id, K[it] = Ye, Mt !== null && bn([Ne, de * 1e3, ne.id, Ye]);
      }
      function di(ne, de) {
        K[xe] = be, K[ge] = 0, K[it] = 0, Mt !== null && bn([st, de * 1e3, ne.id, Ye]);
      }
      function tr(ne) {
      ...
      var Ea = 1073741823, Ti = -1, Xr = 250, Cs = 5e3, Er = 1e4, Ir = Ea, mn = [], qn = [], Ia = 1, kt = null, nn = Fe, Mi = !1, Nn = !1, Ei = !1;
      function Kn(ne) {
      ...
      function yo(ne, de) {
        ...
        for (Kn(Xe), kt = ie(mn); kt !== null && !i && !(kt.expirationTime > Xe && (!ne || y())); ) {
          var pt = kt.callback;
          if (pt !== null) {
            kt.callback = null, nn = kt.priorityLevel;
...
function uO() {
  ...
  var re = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, D = Object.prototype.hasOwnProperty, B = {}, K = {};
  function xe(n) {
    return D.call(K, n) ? !0 : D.call(B, n) ? !1 : re.test(n) ? K[n] = !0 : (B[n] = !0, !1);
  }
  function ge(n, a, u, f) {
    if (u !== null && u.type === 0)
      return !1;
  ...
  var wn = /^(.*)[\\\/]/, Ft = typeof Symbol == "function" && Symbol.for, Ui = Ft ? Symbol.for("react.element") : 60103, Ci = Ft ? Symbol.for("react.portal") : 60106, Jn = Ft ? Symbol.for("react.fragment") : 60107, Ne = Ft ? Symbol.for("react.strict_mode") : 60108, st = Ft ? Symbol.for("react.profiler") : 60114, He = Ft ? Symbol.for("react.provider") : 60109, jt = Ft ? Symbol.for("react.context") : 60110, bn = Ft ? Symbol.for("react.concurrent_mode") : 60111, ci = Ft ? Symbol.for("react.forward_ref") : 60112, Mr = Ft ? Symbol.for("react.suspense") : 60113, Bn = Ft ? Symbol.for("react.suspense_list") : 60120, Gr = Ft ? Symbol.for("react.memo") : 60115, Vi = Ft ? Symbol.for("react.lazy") : 60116, Ta = Ft ? Symbol.for("react.block") : 60121, Ma = typeof Symbol == "function" && Symbol.iterator;
  function di(n) {
  ...
  function ml(n) {
    ...
    for (u = 0; u < n.ancestors.length; u++) {
      ...
      for (var R = null, H = 0; H < ce.length; H++) {
        var U = ce[H];
        U && (U = U.extractEvents(f, a, x, v, T)) && (R = rn(R, U));
      }
      ea(R);
    }
  }
  ...
  function No(n) {
    return n = (n = n.stateNode) && n.__reactInternalMemoizedMergedChildContext || Or, Lr = Pn.current, an(Pn, n), an(Mn, Mn.current), !0;
  }
  function _l(n, a, u) {
    var f = n.stateNode;
    if (!f)
      throw Error(c(169));
    u ? (n = js(n, a, Lr), f.__reactInternalMemoizedMergedChildContext = n, St(Mn), St(Pn), an(Pn, n)) : St(Mn), an(Mn, u);
  }
  ...
  function Lp(n) {
    ...
    function _i(O, _, Q, le) {
      for (var ye = null, ke = null, Je = _, bt = _ = 0, ln = null; Je !== null && bt < Q.length; bt++) {
        Je.index > bt ? (ln = Je, Je = null) : ln = Je.sibling;
        var lt = mt(O, Je, Q[bt], le);
        if (lt === null) {
          Je === null && (Je = ln);
          break;
        }
        n && Je && lt.alternate === null && a(O, Je), _ = x(lt, _, bt), ke === null ? ye = lt : ke.sibling = lt, ke = lt, Je = ln;
      }
      if (bt === Q.length)
        return u(O, Je), ye;
      if (Je === null) {
      ...
      for (Je = f(O, Je); bt < Q.length; bt++)
        ln = Et(Je, O, bt, Q[bt], le), ln !== null && (n && ln.alternate !== null && Je.delete(ln.key === null ? bt : ln.key), _ = x(ln, _, bt), ke === null ? ye = ln : ke.sibling = ln, ke = ln);
    ...
    function Wn(O, _, Q, le) {
      ...
      if (Q = ye.call(Q), Q == null)
        throw Error(c(151));
      for (var ke = ye = null, Je = _, bt = _ = 0, ln = null, lt = Q.next(); Je !== null && !lt.done; bt++, lt = Q.next()) {
        Je.index > bt ? (ln = Je, Je = null) : ln = Je.sibling;
        ...
        n && Je && ns.alternate === null && a(O, Je), _ = x(ns, _, bt), ke === null ? ye = ns : ke.sibling = ns, ke = ns, Je = ln;
      }
      if (lt.done)
        return u(O, Je), ye;
      if (Je === null) {
  ...
  var wc = Zt.ReactCurrentDispatcher, gi = Zt.ReactCurrentBatchConfig, Qn = 0, $t = null, sn = null, on = null, $a = !1;
  function Hn() {
    throw Error(c(321));
  }
  function Fs(n, a) {
  ...
  function If(n, a, u, f, v, x) {
    if (Qn = x, $t = a, a.memoizedState = null, a.updateQueue = null, a.expirationTime = 0, wc.current = n === null || n.memoizedState === null ? Cg : Tg, n = u(f, v), a.expirationTime === Qn) {
      x = 0;
      do {
        if (a.expirationTime = 0, !(25 > x))
          throw Error(c(301));
        x += 1, on = sn = null, a.updateQueue = null, wc.current = Mg, n = u(f, v);
      } while (a.expirationTime === Qn);
    }
    if (wc.current = Ic, a = sn !== null && sn.next !== null, Qn = 0, on = sn = $t = null, $a = !1, a)
      throw Error(c(300));
    return n;
  }
  function $s() {
  ...
  function Hl(n) {
    ...
    var f = sn, v = f.baseQueue, x = u.pending;
    if (x !== null) {
      if (v !== null) {
        var T = v.next;
  ...
  function Ec(n, a, u) {
    ...
    if (x === null ? v.next = v : (v.next = x.next, x.next = v), a.pending = v, x = n.alternate, n === $t || x !== null && x === $t)
      $a = !0, v.expirationTime = Qn, $t.expirationTime = Qn;
    else {
  ...
  function Qp(n, a, u) {
    ...
    if ((R = (a.effectTag & 64) !== 0) || (R = (x & 2) !== 0 && (n === null || n.memoizedState !== null)), R ? (T = !0, a.effectTag &= -65) : n !== null && n.memoizedState === null || v.fallback === void 0 || v.unstable_avoidThisFallback === !0 || (x |= 1), an(Kt, x & 1), n === null) {
  ...
  function um(n, a) {
    do {
      try {
        ...
        if (Qn = 0, on = sn = $t = null, $a = !1, ot === null || ot.return === null)
        ...
        if (f < u) {
          switch (cr = !1, a.tag) {
            ...
            case 4:
              ...
              break;
            case 10:
              f = a.memoizedProps.value, v = a.type._context, an(Ua, v._currentValue), v._currentValue = f;
              break;
            case 13:
    ...
    switch (a.expirationTime = 0, a.tag) {
      ...
      case 10:
        e: {
          ...
          if (an(Ua, R._currentValue), R._currentValue = x, T !== null)
  ...
  return nM || (nM = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    if (typeof window < "u" && typeof window.dispatchEvent == "function" && typeof document < "u" && typeof document.createEvent == "function") {
      var A = document.createElement("react"), I = function(e, t, s, l, d, p, w, b, E) {
        ...
        var we, qe = !1, nt = !1;
        function _t(Qt) {
          if (we = Qt.error, qe = !0, we === null && Qt.colno === 0 && Qt.lineno === 0 && (nt = !0), Qt.defaultPrevented && we != null && typeof we == "object")
            try {
    ...
    var z = C, F = !1, $ = null, ee = !1, q = null, fe = {
      onError: function(e) {
        F = !0, $ = e;
      }
    };
    ...
    var _e = 0, ue = 1, Qe = 2, be = 3, Ve = 4, Re = 5, Fe = 6, Tt = 7, Bt = 8, Ye = 9, re = 10, D = 11, B = 12, K = 13, xe = 14, ge = 15, it = 16, Ge = 17, Le = 18, dt = 19, gt = 20, Zt = 21, Mt = 22, wn = null, Ft = {};
    function Ui() {
      if (!!wn)
        for (var e in Ft) {
          var t = Ft[e], s = wn.indexOf(e);
          if (!(s > -1))
...
Check the render method of \`` + e + "`." : "";
    ...
    var gi = !1, Qn = [], $t = null, sn = null, on = null, $a = /* @__PURE__ */ new Map(), Hn = /* @__PURE__ */ new Map(), Fs = [];
    function If() {
      return Qn.length > 0;
    }
    var $s = [oa, kl, oc, lc, mf, zs, tf, ff, hf, an, Al, tc, Ls, aa, El, Vn, Fi, si, Dl, _l, Do, ec, Kd, ef, Pl, Ml, za, Il, Mn, js], Uo = [Wi, Un, Os, Rl, la, La, St, Ai, sa, rc];
    function Qa(e) {
    ...
    function jp() {
      ...
      $t !== null && Zs($t) && ($t = null), sn !== null && Zs(sn) && (sn = null), on !== null && Zs(on) && (on = null), $a.forEach(Df), Hn.forEach(Df);
    }
    function Vo(e, t) {
...
`).replace(jc, "");
    ...
    function Zo(e) {
      var t = e[qf] || e[Kf];
      return t && (t.tag === Re || t.tag === Fe || t.tag === K || t.tag === be) ? t : null;
    }
    function iu(e) {
    ...
    var CI = pr.extend({
      ...
      data: null
    }), MI = [9, 13, 27, 32], HS = 229, $g = Bn && "CompositionEvent" in window, ih = null;
    Bn && "documentMode" in document && (ih = document.documentMode);
    var EI = Bn && "TextEvent" in window && !ih, WS = Bn && (!$g || ih && ih > 8 && ih <= 11), FS = 32, $S = String.fromCharCode(FS), so = {
      beforeInput: {
        phasedRegistrationNames: {
    ...
    function DI(e, t, s, l) {
      var d, p;
      if ($g ? d = AI(e) : Zc ? ZS(e, s) && (d = so.compositionEnd) : RI(e, s) && (d = so.compositionStart), !d)
        return null;
    ...
    var ZI = {
      ...
      extractEvents: function(e, t, s, l, d) {
        ...
        if (OI(p) ? w = jI : XS(p) ? Qg ? w = $I : (w = HI, b = VI) : WI(p) && (w = FI), w) {
          var E = w(e, t);
          if (E) {
            var N = qS(E, s, l);
            return N;
    ...
    var tx = 0, nx = 0, ix = !1, rx = !1, oh = sh.extend({
      ...
      extractEvents: function(e, t, s, l, d) {
        ...
        return Qt.type = qe + "enter", Qt.target = _t, Qt.relatedTarget = nt, mI(vt, Qt, N, k), (d & Ta) === 0 ? [vt] : [vt, Qt];
      }
    };
    function JI(e, t) {
    ...
    var KI = Bn && "documentMode" in document && document.documentMode <= 11, sx = {
      select: {
        phasedRegistrationNames: {
          bubbled: "onSelect",
    ...
    var lA = sh.extend({
      ...
      deltaZ: null,
      deltaMode: null
    }), hA = [Gd, ec, Ps, _s, Do, nc, Bs, af, sf, Ii, Dl, zr, Oa, of, lf, ic, uf, cf, df, Or, Pn, Mn, Ba, $n, sc, js, No, pf, ko, cc, dc], pA = {
      eventTypes: Nf,
      extractEvents: function(e, t, s, l, d) {
        var p = Mc.get(e);
        if (!p)
    ...
    var ux = "\u269B", vA = "\u26D4", yi = typeof performance < "u" && typeof performance.mark == "function" && typeof performance.clearMarks == "function" && typeof performance.measure == "function" && typeof performance.clearMeasures == "function", su = null, is = null, ou = null, Em = !1, Im = !1, Xg = !1, dh = 0, rs = 0, Am = /* @__PURE__ */ new Set(), Jg = function(e) {
      return ux + " " + e;
    }, gA = function(e, t) {
...
Learn more about this warning here: https://fb.me/react-legacy-context%s`, d, p);
    ...
    var Cy = {}, JA = Array.isArray, i0 = new r.Component().refs, Ty, My, Ey, Iy, Ay, r0, Gm, Ry, Dy, Ny;
    {
...
See https://fb.me/react-refs-must-have-owner for more information.`);
    ...
    function d0(e) {
      ...
      function we(W, te, j, ve) {
        ...
        for (var It = null, Ht = null, At = te, zt = 0, Rt = 0, un = null; At !== null && Rt < j.length; Rt++) {
          At.index > Rt ? (un = At, At = null) : un = At.sibling;
          var In = L(W, At, j[Rt], ve);
          if (In === null) {
            At === null && (At = un);
            break;
          }
          e && At && In.alternate === null && t(W, At), zt = p(In, zt, Rt), Ht === null ? It = In : Ht.sibling = In, Ht = In, At = un;
        }
        if (Rt === j.length)
          return s(W, At), It;
        if (At === null) {
      ...
      function qe(W, te, j, ve) {
        ...
        for (var zt = null, Rt = null, un = te, In = 0, An = 0, bi = null, tn = At.next(); un !== null && !tn.done; An++, tn = At.next()) {
          un.index > An ? (bi = un, un = null) : bi = un.sibling;
          var Bi = L(W, un, tn.value, ve);
          if (Bi === null) {
            un === null && (un = bi);
            break;
          }
          e && un && Bi.alternate === null && t(W, un), In = p(Bi, In, An), Rt === null ? zt = Bi : Rt.sibling = Bi, Rt = Bi, un = bi;
        }
        if (tn.done)
          return s(W, un), zt;
        if (un === null) {
        ...
        for (var sb = l(W, un); !tn.done; An++, tn = At.next()) {
    ...
    var r1 = 0, p0 = 1, Wy = 1, Ih = 2, va = lu(r1);
    function nv(e, t) {
      return (e & t) !== 0;
    }
    function Ah(e) {
    ...
    $y = /* @__PURE__ */ new Set();
    var qo = Ae, Cn = null, wi = null, li = null, av = !1, o1 = 25, ae = null, $r = null, Ko = -1, Qy = !1;
    function en() {
      {
        var e = ae;
        $r === null ? $r = [e] : $r.push(e);
...
Incoming: %s`, ae, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function qy(e, t, s, l) {
      ...
      if (p === null)
        p = u1(), Cn.updateQueue = p, p.lastEffect = d.next = d;
      else {
        var w = p.lastEffect;
        if (w === null)
    ...
    function P0(e) {
      for (var t = e.return; t !== null && t.tag !== Re && t.tag !== be && t.tag !== K; )
        t = t.return;
      Qr = t;
    }
    function wv(e) {
      ...
      if (e.tag !== Re || t !== "head" && t !== "body" && !T(t, e.memoizedProps))
        for (var s = mu; s; )
          D0(e, s), s = Sm(s);
      return P0(e), e.tag === K ? mu = m1(e) : mu = Qr ? Sm(e.stateNode) : null, !0;
    }
    function dw() {
    ...
    function B0(e, t, s, l, d) {
      ...
      var b = t.stateNode, E;
      b === null ? (e !== null && (e.alternate = null, t.alternate = null, t.effectTag |= xn), l0(t, s, l), Py(t, s, l, d), E = !0) : e === null ? E = e1(t, s, l, d) : E = t1(e, t, s, l, d);
    ...
    function ww(e, t, s, l, d, p) {
      ...
      kh.current = t;
      var E;
      return w && typeof s.getDerivedStateFromError != "function" ? (E = null, R0()) : (Nr(!0), E = b.render(), t.mode & gn && b.render(), Nr(!1)), t.effectTag |= lr, e !== null && w ? v1(e, t, E, p) : yr(e, t, E, p), t.memoizedState = b.state, d && Ex(t, s, !0), t.child;
    }
    function j0(e) {
      var t = e.stateNode;
        ...
        if (we !== null) {
          ...
          if (w) {
            ...
            if (zt.return = t, zt.child = Ht, Ht !== null && (Ht.return = zt), (t.mode & Hr) === oi) {
              var Rt = t.memoizedState, un = Rt !== null ? t.child.child : t.child;
              zt.child = un;
              for (var In = un; In !== null; )
      ...
      switch (t.tag) {
        ...
        case Fe: {
          ...
          if (e && t.stateNode != null) {
            ...
            qe ? p1(t) && vd(t) : t.stateNode = H(L, me, we, t);
          }
          return null;
        }
        case K: {
        ...
        case dt: {
          ...
          if (yt === null)
            ...
            if (!Me) {
              ...
              if (Rt !== null) {
                t.effectTag |= Ut, Me = !0;
                var un = Rt.updateQueue;
                if (un !== null && (t.updateQueue = un, t.effectTag |= xt), Sv(pe, !0), pe.tail === null && pe.tailMode === "hidden" && !yt.alternate) {
...
Learn more about data fetching with Hooks: https://fb.me/react-hooks-data-fetching` : E = " You returned: " + b, g("An effect function must not return anything besides a function, which is used for clean-up.%s%s", E, Fn(t));
    ...
    function $1(e, t) {
      for (var s = e; ; ) {
        ...
        } else if (s.tag === K && s.memoizedState !== null && s.memoizedState.dehydrated === null) {
    ...
    function uC(e, t, s) {
      ...
      return w !== null && typeof w.componentDidCatch == "function" ? l.callback = function() {
        Zx(e), typeof d != "function" && (kR(this), Ew(e, t));
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` + Fn(s));
    ...
    var rR = Math.ceil, Dw = m.ReactCurrentDispatcher, cC = m.ReactCurrentOwner, Nw = m.IsSomeRendererActing, En = 0, xv = 1, aR = 2, dC = 4, kw = 8, wr = 16, hs = 32, yu = 0, Cv = 1, fC = 2, Tv = 3, Mv = 4, Pw = 5, rt = En, Gi = null, We = null, ui = Ae, Zn = yu, Ev = null, ho = Ct, Ph = Ct, Iv = null, _h = Ae, Av = !1, _w = 0, hC = 500, Ue = null, Rv = !1, zw = null, gd = null, zh = !1, yd = null, Oh = Kc, Ow = Ae, wu = null, sR = 50, Lh = 0, Lw = null, oR = 50, Dv = 0, Bh = null, bu = null, jh = Ae;
    function ps() {
        ...
        case Mv: {
          ...
          if (l === N && (e.nextKnownPendingLevel = jw(t)), !Mu.current) {
            ...
            if (Ph !== Ct)
              ...
              var J = xR(ho), me = vr(), we = cu(l) - me, qe = me - J;
              qe < 0 && (qe = 0), L = BR(qe) - qe, we < L && (L = we);
            }
            if (L > 10) {
    ...
    function CC(e) {
      ...
      do {
        ...
        if ((We.effectTag & _o) === Pt) {
          Co(We);
          var l = void 0;
          if ((We.mode & cs) === oi ? l = X0(t, We, ui) : (uw(We), l = X0(t, We, ui), yv(We, !1)), px(We), rr(), ER(We), l !== null)
            return l;
    ...
    function IR(e, t) {
      ...
      if (J !== Ae) {
        ...
        gd = null;
      if (X || PC(e, l), J === Ct ? e === Lw ? Lh++ : (Lh = 0, Lw = e) : Lh = 0, qR(s.stateNode, l), br(e), Rv) {
        Rv = !1;
        var qe = zw;
        throw zw = null, qe;
      }
...
For more info, visit https://fb.me/react-mock-scheduler`));
    ...
    var nD = 1;
    function iD(e, t, s, l) {
      this.tag = e, this.key = s, this.elementType = null, this.type = null, this.stateNode = null, this.return = null, this.child = null, this.sibling = null, this.index = 0, this.ref = null, this.pendingProps = t, this.memoizedProps = null, this.updateQueue = null, this.memoizedState = null, this.dependencies = null, this.mode = l, this.effectTag = Pt, this.nextEffect = null, this.firstEffect = null, this.lastEffect = null, this.expirationTime = Ae, this.childExpirationTime = Ae, this.alternate = null, this.actualDuration = Number.NaN, this.actualStartTime = Number.NaN, this.selfBaseDuration = Number.NaN, this.treeBaseDuration = Number.NaN, this.actualDuration = 0, this.actualStartTime = -1, this.selfBaseDuration = 0, this.treeBaseDuration = 0, this._debugID = nD++, this._debugIsCurrentlyTiming = !1, this._debugSource = null, this._debugOwner = null, this._debugNeedsRemount = !1, this._debugHookTypes = null, !Yw && typeof Object.preventExtensions == "function" && Object.preventExtensions(this);
    }
    ...
    function oD(e) {
      var t;
      return e === AA ? t = td | Hr | gn : e === IA ? t = Hr | gn : t = oi, GR && (t |= cs), ya(be, null, null, t);
    }
    function Xw(e, t, s, l, d, p) {
      var w, b = Qe, E = e;
      if (typeof e == "function")
  ...
  i.one("ready", () => {
    ...
    Yn(">>> Setup", { playingId: g, src: y }), r.addListener("error", (S) => {
      ...
      r.getEffectCurrentPosition(g).then((S) => {
        ...
        function F(ee, q) {
          r.setEffectPosition(q, 1e3 * ee), C.previousBeginSeekTime = Date.now() / 1e3, C.previousSeekTargetTime = ee;
        }
        const $ = C.previousBeginSeekTime;
        if (S > 0) {
          const ee = I - A, q = Math.abs(ee), fe = 0.5;
          if (q > fe)
            if (z) {
              const se = C.previousSeekTargetTime - A, Z = Date.now() / 1e3 - $, ce = Z + (ee > 0 ? ee : 0), oe = I + ce;
              F(oe, g), Yn(">>> Start seeking after seeking lag", { jsPlayerTime: I, rtcEffectTime: A, jsPlayerTimerAdvance: ee, lastSeekingCost: Z, estimatedRTCLag: ce, targetRTCSeekTime: oe, previousBeginSeekTime: $, timeElapse: se });
            } else if (q > 10)
              F(I, g), Yn(">>> DirectSeek", { time: I, rtcEffectTime: A, jsPlayerTimerAdvance: ee });
            else {
              const se = C.previousVideoJSAdvance, Z = 0, ce = I + Z;
              C.previousVideoJSAdvance = Z, F(ce, g), Yn(">>> Start seeking with lag", { jsPlayerTime: I, rtcEffectTime: A, jsPlayerTimerAdvance: ee, previousAdvance: se, estimatedRTCLag: Z, targetRTCSeekTime: ce });
            }
          else
            z && (Yn(">>> SeekingFinish no lag", { jsPlayerTime: I, rtcEffectTime: A, jsPlayerTimerAdvance: ee, previousBeginSeekTime: $, rtcLagTolerance: fe }), C.previousBeginSeekTime = 0, C.previousSeekTargetTime = 0);
        }
      });
    }), i.on("dispose", () => {
...
const al = {
  ...
  Show: "show",
  Hide: "hide"
}, FO = (r, i) => new Array(r).fill(0).map((o, c) => i(c)), cn = class {
  constructor(r, i) {
  ...
  computedStyle(r) {
    ...
    if (this.iframe) {
      const { width: h, height: m, scale: y, centerX: g, centerY: S } = i, C = this.rootRect || { x: 0, y: 0 }, A = `${h / 2 + C.x}px`, I = `${m / 2 + C.y}px`, z = `transform-origin: ${A} ${I};`, F = (h - o) / 2 * y, $ = (m - c) / 2 * y, ee = -(g * y) + F, q = -(S * y) + $, fe = `transform: translate(${ee}px,${q}px) scale(${y}, ${y});`, Oe = ["position: absolute;", "border: 0.1px solid rgba(0,0,0,0);", "top: 0px;", "left: 0px;", z, fe];
...
Pd.displayer = null;
Pd.alreadyCreate = !1;
const $O = new VP({ emitter: Ke }), tt = class extends XD {
  constructor(r) {
