...
import { debounce, isEqual, omit, isObject, has, get, size as size$1, mapValues, noop as noop$2, pick, isEmpty, isInteger, orderBy, isFunction, isNumber, throttle, isNull } from "lodash";
...
const genAppId = async (kind2) => {
  var _a3, _b;
  const impl = await ((_a3 = appRegister.appClasses.get(kind2)) == null ? void 0 : _a3());
...
const getScenePath = (room, dir, index2) => {
  ...
  if (room && dir) {
    ...
    const scene = (_a3 = scenes[dir]) == null ? void 0 : _a3[index2];
    if (scene) {
...
const putScenes = (room, path, scenes, index2) => {
  ...
  for (let i2 = 0; i2 < scenes.length; ++i2) {
    if ((_a3 = scenes[i2].name) == null ? void 0 : _a3.includes("/")) {
...
class AppListeners {
  constructor(manager) {
    ...
    this.appMoveHandler = (payload) => {
      var _a3;
      (_a3 = this.boxManager) == null ? void 0 : _a3.moveBox(payload);
    };
    this.appResizeHandler = (payload) => {
      var _a3, _b;
      (_a3 = this.boxManager) == null ? void 0 : _a3.resizeBox(Object.assign(payload, { skipUpdate: true }));
...
class Storage {
  ...
  _getRawState(defaultValue) {
    var _a3;
    if (this.id === null) {
      return (_a3 = this._context.getAttributes()) != null ? _a3 : defaultValue;
    } else {
          ...
          switch (action.kind) {
            ...
            default: {
              ...
              if (isRef(value)) {
                ...
                if (isObject(curValue) && ((_a3 = this._refMap.get(curValue)) == null ? void 0 : _a3.k) === k2) {
                  newValue = curValue;
                } else {
                  newValue = v2;
                  if (isObject(v2)) {
  ...
  constructor(manager, boxManager, appId, appProxy, appOptions) {
    ...
    this.mountView = (dom) => {
      ...
      if (view) {
        ...
        setTimeout(() => {
          var _a3;
          (_a3 = this.getRoom()) == null ? void 0 : _a3.refreshViewSize();
    ...
    this.setScenePath = async (scenePath) => {
      ...
      (_a3 = this.getRoom()) == null ? void 0 : _a3.setScenePath(scenePath);
    };
    this.getAppOptions = () => {
    ...
    this.dispatchMagixEvent = (...args) => {
      ...
      return (_a3 = this.manager.room) == null ? void 0 : _a3.dispatchMagixEvent(appScopeEvent, args[1]);
    };
...
class AppPageStateImpl {
  ...
  getFullPath(index2) {
    var _a3;
    const scenes = (_a3 = this.sceneNode) == null ? void 0 : _a3.scenes;
  ...
  toObject() {
    var _a3, _b;
    return {
      index: ((_a3 = this.params.view) == null ? void 0 : _a3.focusSceneIndex) || 0,
      length: ((_b = this.sceneNode) == null ? void 0 : _b.scenes.length) || 0
    };
  }
  destroy() {
    var _a3;
    (_a3 = this.sceneNode) == null ? void 0 : _a3.dispose();
  }
}
...
var createStep = function(setRunNextFrame) {
  ...
  var renderStep = {
    ...
    process: function(frame2) {
      var _a3;
      isProcessing2 = true;
      _a3 = [processToRunNextFrame, processToRun], processToRun = _a3[0], processToRunNextFrame = _a3[1];
...
var rgbaTemplate = function(_a3) {
  var red = _a3.red, green = _a3.green, blue = _a3.blue, _b = _a3.alpha, alpha2 = _b === void 0 ? 1 : _b;
  return "rgba(" + red + ", " + green + ", " + blue + ", " + alpha2 + ")";
};
var hslaTemplate = function(_a3) {
  var hue = _a3.hue, saturation = _a3.saturation, lightness = _a3.lightness, _b = _a3.alpha, alpha2 = _b === void 0 ? 1 : _b;
...
var rgba = {
  ...
  transform: function(_a3) {
    var red = _a3.red, green = _a3.green, blue = _a3.blue, _b = _a3.alpha, alpha$1 = _b === void 0 ? 1 : _b;
    return rgbaTemplate({
...
var hsla = {
  ...
  transform: function(_a3) {
    var hue = _a3.hue, saturation = _a3.saturation, lightness = _a3.lightness, _b = _a3.alpha, alpha$1 = _b === void 0 ? 1 : _b;
    return hslaTemplate({
      hue: Math.round(hue),
...
var createStyler = function(_a3) {
  var onRead2 = _a3.onRead, onRender2 = _a3.onRender, _b = _a3.uncachedValues, uncachedValues = _b === void 0 ? /* @__PURE__ */ new Set() : _b, _c = _a3.useCache, useCache = _c === void 0 ? true : _c;
  return function(_a22) {
    if (_a22 === void 0) {
      _a22 = {};
    }
    var props = __rest(_a22, []);
    var state = {};
    var changedValues = [];
...
function createStyleBuilder(_a3) {
  var _b = _a3 === void 0 ? {} : _a3, _c = _b.enableHardwareAcceleration, enableHardwareAcceleration = _c === void 0 ? true : _c, _d = _b.isDashCase, isDashCase = _d === void 0 ? true : _d, _e = _b.allowTransformNone, allowTransformNone = _e === void 0 ? true : _e;
  var styles2 = {};
  var transform = {};
  var transformOrigin = {};
  var transformKeys = [];
...
function onRender(state, _a3, changedValues) {
  var element2 = _a3.element, buildStyles = _a3.buildStyles, hasCSSVariable = _a3.hasCSSVariable;
...
function createCssStyler(element2, _a3) {
  if (_a3 === void 0) {
    _a3 = {};
  }
  var enableHardwareAcceleration = _a3.enableHardwareAcceleration, allowTransformNone = _a3.allowTransformNone, props = __rest(_a3, ["enableHardwareAcceleration", "allowTransformNone"]);
...
function buildSVGAttrs(_a3, dimensions, totalPathLength, cssBuilder, attrs, isDashCase) {
  ...
  var attrX = _a3.attrX, attrY = _a3.attrY, originX = _a3.originX, originY = _a3.originY, pathLength = _a3.pathLength, _b = _a3.pathSpacing, pathSpacing = _b === void 0 ? 1 : _b, _c = _a3.pathOffset, pathOffset = _c === void 0 ? 0 : _c, state = __rest(_a3, ["attrX", "attrY", "originX", "originY", "pathLength", "pathSpacing", "pathOffset"]);
...
var svgStyler = /* @__PURE__ */ createStyler({
  onRead: function(key, _a3) {
    var element2 = _a3.element;
  ...
  onRender: function(state, _a3) {
    var element2 = _a3.element, buildAttrs = _a3.buildAttrs;
...
var viewport = /* @__PURE__ */ createStyler({
  ...
  onRender: function(_a3) {
    var _b = _a3.scrollTop, scrollTop = _b === void 0 ? 0 : _b, _c = _a3.scrollLeft, scrollLeft = _c === void 0 ? 0 : _c;
...
class DefaultTitleBar {
  constructor({
    ...
    this.handleTitleBarClick = (ev) => {
      ...
      if ((_a3 = ev.target.dataset) == null ? void 0 : _a3.teleTitleBarNoDblClick) {
        return;
      }
      preventEvent$1(ev);
      const now = Date.now();
  ...
  setReadonly(readonly) {
    ...
    if (this.readonly !== readonly) {
      this.readonly = readonly;
      (_a3 = this.$buttonsContainer) == null ? void 0 : _a3.classList.toggle(
        this.wrapClassName("titlebar-btns-disable"),
        Boolean(isAndroid$2() || isIOS$2() || this.readonly)
      );
    }
  }
  render() {
    if (!this.$titleBar) {
      ...
      $buttonsContainer.classList.toggle(
        this.wrapClassName("titlebar-btns-disable"),
        isAndroid$2() || isIOS$2() || this.readonly
      );
      ...
      this.sideEffect.addEventListener(
        ...
        (ev) => {
          ...
          const teleTitleBarBtnIndex = Number(
            (_a3 = target.dataset) == null ? void 0 : _a3.teleTitleBarBtnIndex
          );
...
class TeleBox {
  constructor({
    ...
    this.handleTrackStart = (ev) => {
      var _a3;
      return (_a3 = this._handleTrackStart) == null ? void 0 : _a3.call(this, ev);
    };
    this.hasHeader = hasHeader;
    this._sideEffect = new o$1();
    this._valSideEffectBinder = c(
      this._sideEffect
    );
    const { combine, createVal } = this._valSideEffectBinder;
    this.addObserver = addObserver || noop$1;
    this.allBoxStatusInfoManager = allBoxStatusInfoManager;
    this.wukongRoleManager = wukongRoleManager;
    this.id = id2;
    this.namespace = namespace;
    ...
    this.titleBar = titleBar || new DefaultTitleBar({
      ...
      onDragStart: (event) => {
        var _a3;
        return (_a3 = this._handleTrackStart) == null ? void 0 : _a3.call(this, event);
      },
      onEvent: (event) => {
        if (this._delegateEvents.listeners.length > 0) {
          ...
          switch (event.type) {
            case TELE_BOX_DELEGATE_EVENT.Maximize: {
              console.log(
                "[TeleBox] TeleBox TitleBar Maximize Event",
                {
                  boxId: this.id,
                  currentMaximized: maximized$.value
                }
              );
              break;
            }
            case TELE_BOX_DELEGATE_EVENT.Minimize: {
              console.log(
                "[TeleBox] TeleBox TitleBar Minimize Event",
                {
                  boxId: this.id,
                  currentMinimized: minimized$.value
                }
              );
              break;
            }
            case TELE_BOX_DELEGATE_EVENT.Close: {
              console.log(
                "[TeleBox] TeleBox TitleBar Close Event",
                {
                  boxId: this.id,
                  currentVisible: visible$.value
                }
              );
              break;
            }
  ...
  render(root) {
    ...
    $contentWrap.classList.toggle(
      "hide-scroll",
      Boolean(isIOS$2() || isAndroid$2() || true !== ((_a3 = this.wukongRoleManager) == null ? void 0 : _a3.wukongCanOperate()))
    );
    const $content = document.createElement("div");
    $content.className = this.wrapClassName("content") + " tele-fancy-scrollbar";
    this.$content = $content;
    if ((_b = this.id) == null ? void 0 : _b.includes("Plyr")) {
  ...
  _renderResizeHandlers() {
    ...
    const handleTrackStart = (ev) => {
      ...
      const target = ev.target;
      if ((_a3 = target.dataset) == null ? void 0 : _a3.teleBoxHandle) {
        preventEvent$1(ev);
        trackStartX = this.x;
        trackStartY = this.y;
...
class TeleBoxCollector {
  constructor({
    ...
    this.popupVisible$.reaction((popupVisible) => {
      var _a3;
      (_a3 = this.$titles) == null ? void 0 : _a3.classList.toggle(
      ...
      requestAnimationFrame(() => {
        requestAnimationFrame(() => {
          var _a22;
          (_a22 = this.$titles) == null ? void 0 : _a22.classList.toggle(
            this.wrapClassName("collector-titles-visible"),
            popupVisible
          );
        });
      });
    ...
    const blurPopup = (ev) => {
      ...
      if (!this.popupVisible$)
        return;
      const target = ev.target;
      if ((_b = (_a3 = target.className) == null ? void 0 : _a3.includes) == null ? void 0 : _b.call(_a3, "collector"))
        return;
  ...
  setVisible(visible) {
    ...
    if (this._visible !== visible) {
      this._visible = visible;
      if (this.$collector) {
        (_a3 = this.wrp$) == null ? void 0 : _a3.classList.toggle(
  ...
  renderTitles() {
    ...
    if (!existContent) {
      ...
      this._sideEffect.addEventListener(
        ...
        (ev) => {
          ...
          const target = ev.target;
          if ((_b2 = (_a22 = target.dataset) == null ? void 0 : _a22.teleBoxID) == null ? void 0 : _b2.length) {
    ...
    $content.innerHTML = "";
    const disposers = (_a3 = this.boxes) == null ? void 0 : _a3.filter(
      (box) => this.allBoxStatusInfoManager.currentAllBoxStatusInfo$.value[box.id] === TELE_BOX_STATE.Minimized
    ).map((box) => {
    ...
    onTickEnd(() => {
      ...
      if (!this.root)
        return;
      const parentRect = (_a22 = this.wrp$) == null ? void 0 : _a22.getBoundingClientRect();
...
var TELE_BOX_MANAGER_EVENT = /* @__PURE__ */ ((TELE_BOX_MANAGER_EVENT2) => {
  ...
  TELE_BOX_MANAGER_EVENT2["AllBoxStatusInfo"] = "all_box_status_info";
  TELE_BOX_MANAGER_EVENT2["LastLastNotMinimizedBoxsStatus"] = "last_last_not_minimized_boxs_status";
...
class MaxTitleBar extends DefaultTitleBar {
  ...
  renderTitles() {
    ...
    const maxBoxes = this.boxes.filter((box) => maximizedBoxes.includes(box.id)).filter((box) => !minimizedBoxes.includes(box.id)).filter((box) => box.hasHeader);
    const noHeaderBoxes = this.boxes.filter((box) => maximizedBoxes.includes(box.id)).filter((box) => !minimizedBoxes.includes(box.id)).filter((box) => !box.hasHeader);
    if (this.$titleBar) {
...
class TeleBoxManager {
  constructor({
    ...
    this._darkMode$.reaction((darkMode, _2, skipUpdate) => {
      this.boxes$.value.forEach(
        (box) => box.setDarkMode(darkMode, skipUpdate)
      );
      if (!skipUpdate) {
    ...
    readonly$.reaction((readonly2, _2, skipUpdate) => {
      this.boxes$.value.forEach(
        (box) => box.setReadonly(readonly2, skipUpdate)
      );
    });
    ...
    allBoxStatusInfoManager.currentAllBoxStatusInfo$.reaction((allBoxStatusInfo, _2, skipUpdate) => {
      var _a22, _b;
      ...
      this.boxes$.value.forEach((box) => {
        ...
        box.setMaximized(isMaximized, true);
      ...
      (_a22 = collector$.value) == null ? void 0 : _a22.setVisible(minimized);
      if (minimized) {
    ...
    this.allBoxStatusInfoManager.lastNotMinimizedBoxsStatus$.reaction(
      (lastLastNotMinimizedBoxsStatus, _2, skipUpdate) => {
        if (!skipUpdate) {
          this.events.emit(
    ...
    fence$.subscribe((fence2, _2, skipUpdate) => {
      this.boxes$.value.forEach((box) => box.setFence(fence2, skipUpdate));
    });
    const containerRect$ = createVal(containerRect, shallowequal);
    ...
    const collector$ = createVal(
      collector === null ? null : collector || new TeleBoxCollector({
        visible: this.allBoxStatusInfoManager.getBoxesList(TELE_BOX_STATE.Minimized).length > 0 && false !== ((_a3 = this.wukongRoleManager) == null ? void 0 : _a3.wukongCanOperate()),
        readonly: readonly$.value,
        namespace,
    ...
    readonly$.subscribe((readonly2) => {
      var _a22, _b;
      (_a22 = collector$.value) == null ? void 0 : _a22.setReadonly(readonly2);
      (_b = collector$.value) == null ? void 0 : _b.setVisible(
        this.allBoxStatusInfoManager.getBoxesList(TELE_BOX_STATE.Minimized).length > 0 && !readonly$.value
      );
    });
    this._darkMode$.subscribe((darkMode) => {
      var _a22;
      (_a22 = collector$.value) == null ? void 0 : _a22.setDarkMode(darkMode);
    });
    const calcCollectorRect = () => {
      var _a22;
      if ((_a22 = collector$.value) == null ? void 0 : _a22.$collector) {
    ...
    const checkFocusBox = (ev) => {
      ...
      for (let el = target; el; el = el.parentElement) {
        ...
        const id2 = (_a22 = el.dataset) == null ? void 0 : _a22.teleBoxID;
        if (id2) {
    ...
    this.maxTitleBar = new MaxTitleBar({
      ...
      onEvent: (event) => {
        var _a22, _b, _c;
        if (!((_a22 = this.topBox) == null ? void 0 : _a22.id)) {
          return;
        }
        const currentOptionBox = {
          ...event,
          boxId: ((_b = this.maxTitleBar.focusedBox) == null ? void 0 : _b.id) || ((_c = this.topBox) == null ? void 0 : _c.id),
          hasFocus: this.focusBox !== void 0 && this.focusBox !== null
        };
        switch (event.type) {
          case TELE_BOX_DELEGATE_EVENT.Maximize: {
            console.log(
            ...
            if (currentOptionBox.hasFocus) {
              ...
              this.allBoxStatusInfoManager.setCurrentBoxState(currentOptionBox.boxId, TELE_BOX_STATE.Maximized === allBoxStatusInfo[currentOptionBox.boxId] ? TELE_BOX_STATE.Normal : TELE_BOX_STATE.Maximized, false);
            }
            this.events.emit(
              TELE_BOX_MANAGER_EVENT.BoxToMaximized,
              {
    ...
    this.boxes$.reaction((boxes) => {
      ...
      (_a22 = this.collector) == null ? void 0 : _a22.setBoxes(boxes);
    });
    const valConfig = {
      prefersColorScheme: prefersColorScheme$,
      containerRect: containerRect$,
  ...
  create(config, smartPosition = true) {
    ...
    box._zIndex$.reaction((_2, __, skipUpdate) => {
      ...
      const list = this.boxes$.value.filter((item) => this.allBoxStatusInfoManager.getBoxesList(TELE_BOX_STATE.Maximized).includes(item.id)).sort((a2, b2) => b2.zIndex - a2.zIndex);
  ...
  focusTopBox() {
    ...
    console.log("[TeleBox] FocusTopBox Called", {
      topBox: (_a3 = this.topBox) == null ? void 0 : _a3.id,
      topBoxFocus: (_b = this.topBox) == null ? void 0 : _b.focus
    });
  ...
  updateBox(box, config, skipUpdate = false) {
    ...
    if ((_a3 = box.id) == null ? void 0 : _a3.includes("audio")) {
  ...
  makeBoxTop(box, skipUpdate = false) {
    ...
    console.log(
      ...
      box.zIndex,
      " Original TopBox ",
      (_a3 = this.topBox) == null ? void 0 : _a3.id,
      (_b = this.topBox) == null ? void 0 : _b.zIndex
    );
    if (this.topBox) {
      if (box !== this.topBox) {
        const maximizedBoxes = this.allBoxStatusInfoManager.getBoxesList(TELE_BOX_STATE.Maximized);
  ...
  makeBoxTopFromNotMinimized(topFocusBox = void 0, skipUpdate = false) {
    console.log("[TeleBox] MakeBoxTopFromNotMinimized Called", {
      topFocusBox: topFocusBox == null ? void 0 : topFocusBox.id,
      skipUpdate
    });
    if (!topFocusBox) {
      const allBoxStatusInfo2 = this.allBoxStatusInfoManager.getAllBoxStatusInfo();
      const notMinimizedBoxes = Object.entries(allBoxStatusInfo2).filter(([_2, state]) => state !== TELE_BOX_STATE.Minimized).map(([boxId, _2]) => boxId);
      const filteredBoxes = this.boxes.filter(
        (box) => notMinimizedBoxes.includes(box.id)
      );
    ...
    if (allBoxStatusInfo[topFocusBox.id] === TELE_BOX_STATE.Maximized) {
      ...
      const maximizedBoxes = this.boxes.filter(
        (box) => allBoxStatusInfo[box.id] === TELE_BOX_STATE.Maximized
      );
      if (maximizedBoxes.length > 0) {
  ...
  makeBoxTopFromMaximized(boxId) {
    ...
    if (boxId) {
      if (maximizedBoxes.includes(boxId) && !minimizedBoxes.includes(boxId)) {
        maxIndexBox = this.boxes$.value.find((box) => box.id === boxId);
        console.log(
          "[TeleBox] MakeBoxTopFromMaximized - Found Specific Box",
          { boxId, maxIndexBox: maxIndexBox == null ? void 0 : maxIndexBox.id }
        );
      }
    } else {
      const allBoxStatusInfo = this.allBoxStatusInfoManager.getAllBoxStatusInfo();
      const maximizedBoxes2 = (_a3 = this.boxes) == null ? void 0 : _a3.filter(
        (box) => allBoxStatusInfo[box.id] === TELE_BOX_STATE.Maximized
      );
      if (maximizedBoxes2 && maximizedBoxes2.length > 0) {
        maxIndexBox = maximizedBoxes2.reduce((maxBox, box) => {
          return maxBox.zIndex > box.zIndex ? maxBox : box;
        });
        if (maxIndexBox) {
          console.log(
    ...
    console.log("[TeleBox] MakeBoxTopFromMaximized Result", {
      result,
      maxIndexBox: maxIndexBox == null ? void 0 : maxIndexBox.id
    });
    return result;
  }
  getBoxIndex(boxOrID) {
...
const _ua$1 = (_a2 = window.navigator) == null ? void 0 : _a2.userAgent;
_ua$1 == null ? void 0 : _ua$1.match(/(Edge?)\/(\d+)/);
const isIOS$1 = () => {
  return typeof navigator !== "undefined" && typeof window !== "undefined" && /iPad|iPhone|iPod/.test(_ua$1);
};
const isAndroid$1 = () => {
  return typeof navigator !== "undefined" && /Android/.test(_ua$1);
};
  ...
  return new BoxManager(
    {
      ...
      updateAppState: (...args) => {
        var _a3;
        return (_a3 = manager.appManager) == null ? void 0 : _a3.store.updateAppState(...args);
      },
      canOperate: () => manager.canOperate,
      notifyContainerRectUpdate: (rect) => {
        var _a3;
        return (_a3 = manager.appManager) == null ? void 0 : _a3.notifyContainerRectUpdate(rect);
      },
      cleanFocus: () => {
        var _a3;
        return (_a3 = manager.appManager) == null ? void 0 : _a3.store.cleanFocus();
      },
      setAppFocus: (appId) => {
        var _a3;
        return (_a3 = manager.appManager) == null ? void 0 : _a3.store.setAppFocus(appId, true);
      },
...
class BoxManager {
  constructor(context, createTeleBoxManagerConfig) {
    ...
    this.teleBoxManager.events.on("all_box_status_info", (info) => {
      ...
      (_a3 = this.context.manager.appManager) == null ? void 0 : _a3.store.setAllBoxStatusInfo(allBoxStatusInfo);
      Object.entries(allBoxStatusInfo).filter(([_2, state]) => state === TELE_BOX_STATE.Maximized).map(([boxId, _2]) => boxId);
      const minimizedBoxes = Object.entries(allBoxStatusInfo).filter(([_2, state]) => state === TELE_BOX_STATE.Minimized).map(([boxId, _2]) => boxId);
      callbacks2.emit("onAllBoxStatusInfo", allBoxStatusInfo);
      if (minimizedBoxes.length > 0) {
        setTimeout(() => {
          const offset = 1e-4 * (Math.random() > 0.5 ? 1 : -1);
          this.teleBoxManager.boxes.forEach((box) => {
            var _a4;
            if ((_a4 = box.id) == null ? void 0 : _a4.toLocaleLowerCase().includes("slide")) {
    ...
    this.teleBoxManager.events.on("last_last_not_minimized_boxs_status", (info) => {
      ...
      (_a3 = this.context.manager.appManager) == null ? void 0 : _a3.store.setLastNotMinimizedBoxsStatus(lastLastNotMinimizedBoxsStatus);
    });
    ...
    this.teleBoxManager.events.on("z_index", (box) => {
      ...
      callbacks2.emit("appZIndexChange", { appId: box.id, box });
    });
    emitter.on("playgroundSizeChange", () => this.updateManagerRect());
    emitter.on("updateManagerRect", () => this.updateManagerRect());
    emitter.on("onScaleChange", ({ appId, scale: scale2 }) => {
      this.changeScale(appId, scale2);
    });
  }
  get mainView() {
  ...
  get maximized() {
    var _a3;
    const allBoxStatusInfo = (_a3 = this.context.manager.appManager) == null ? void 0 : _a3.store.getAllBoxStatusInfo();
    if (!allBoxStatusInfo)
      return [];
  ...
  get minimized() {
    ...
    if (!allBoxStatusInfo)
      return [];
    return Object.entries(allBoxStatusInfo).filter(([_2, state]) => state === TELE_BOX_STATE.Minimized).map(([boxId, _2]) => boxId);
  }
  get darkMode() {
  ...
  changeScale(appId, scale2) {
    this.teleBoxManager.setScaleContent(appId, scale2);
  }
  createBox(params) {
    var _a3, _b, _c, _d, _e, _f, _g;
    if (!this.teleBoxManager)
      return;
    let { minwidth = MIN_WIDTH, minheight = MIN_HEIGHT } = (_a3 = params.app.config) != null ? _a3 : {};
    ...
    const createBoxConfig = {
      ...
      height,
      id: params.appId,
      hasHeader: ((_d = params.appId) == null ? void 0 : _d.includes("audio")) ? false : (_f = (_e = params.options) == null ? void 0 : _e.hasHeader) != null ? _f : true
    };
    ...
    (_g = this.manager.scrollerManager) == null ? void 0 : _g.add({
      appId: params.appId,
      manager: this.manager,
      scrollElement: box == null ? void 0 : box.$contentWrap
    });
  }
  ...
  setupBoxManager(createTeleBoxManagerConfig) {
    ...
    const initManagerState = {
      ...
      allBoxStatusInfoManager: (_a3 = this.manager.appManager) == null ? void 0 : _a3.allBoxStatusInfoManager,
  ...
  closeBox(appId, skipUpdate = false) {
    var _a3;
    (_a3 = this.manager.scrollerManager) == null ? void 0 : _a3.remove(appId);
  ...
  updateManagerRect() {
    var _a3;
    const rect = (_a3 = WindowManager.wrapper) == null ? void 0 : _a3.getBoundingClientRect();
  ...
  setReadonly(readonly) {
    this.teleBoxManager.setReadonly(readonly || isIOS$1() || isAndroid$1());
  }
...
var Fields = /* @__PURE__ */ ((Fields2) => {
  ...
  Fields2["LaserPointerActive"] = "laserPointerActive";
  Fields2["AllBoxStatusInfo"] = "allBoxStatusInfo";
  Fields2["LastNotMinimizedBoxsStatus"] = "lastNotMinimizedBoxsStatus";
  Fields2["ViewScrollChange"] = "viewScrollChange";
  Fields2["MainViewBackgroundInfo"] = "mainViewBackgroundInfo";
  Fields2["Scale"] = "Scale";
  Fields2["TeacherInfo"] = "teacher";
  return Fields2;
})(Fields || {});
class AttributesDelegate {
  ...
  setTeacherInfo(teacherInfo) {
    this.context.safeSetAttributes({ ["teacher"]: teacherInfo });
  }
  getTeacherInfo() {
    return get(this.attributes, ["teacher"]);
  }
  getMinimized() {
    const allBoxStatusInfo = this.getAllBoxStatusInfo();
    if (!allBoxStatusInfo)
  ...
  setAllBoxStatusInfo(allBoxStatusInfo) {
    console.log("[TeleBox] AttributesDelegate - setAllBoxStatusInfo", allBoxStatusInfo);
    this.context.safeSetAttributes({ ["allBoxStatusInfo"]: allBoxStatusInfo });
  }
  getAllBoxStatusInfo() {
    return get(this.attributes, ["allBoxStatusInfo"]);
  }
  getLaserPointerActive() {
    return get(this.attributes, ["laserPointerActive"]);
  }
  setLaserPointerActive(active, uid) {
    this.context.safeSetAttributes({ ["laserPointerActive"]: { active, uid } });
  }
  setBoxStatusInfo(id2, status) {
    this.context.safeUpdateAttributes(["allBoxStatusInfo", id2], status);
  }
  getBoxStatusInfo(id2) {
    return get(this.attributes, ["allBoxStatusInfo", id2]);
  }
  getLastNotMinimizedBoxsStatus() {
    return get(this.attributes, ["lastNotMinimizedBoxsStatus"]);
  }
  setLastNotMinimizedBoxsStatus(lastNotMinimizedBoxsStatus) {
    this.context.safeSetAttributes({ ["lastNotMinimizedBoxsStatus"]: lastNotMinimizedBoxsStatus });
  }
  setViewScrollChange(data) {
    console.log(`${logFirstTag} ViewScrollChange Set`, JSON.stringify(data));
    this.context.safeSetAttributes({ ["viewScrollChange"]: data });
  }
  getViewScrollChange() {
    return get(this.attributes, ["viewScrollChange"]);
  }
  getLastNotMinimizedBoxStatus(id2) {
    return get(this.attributes, ["lastNotMinimizedBoxsStatus", id2]);
  }
  setLastNotMinimizedBoxStatus(id2, status) {
    this.context.safeUpdateAttributes(["lastNotMinimizedBoxsStatus", id2], status);
  }
  ...
  getAppSceneIndex(id2) {
    var _a3;
    return (_a3 = this.getAppState(id2)) == null ? void 0 : _a3[AppAttributes.SceneIndex];
  }
  getAppScenePath(id2) {
    var _a3, _b;
    return (_b = (_a3 = this.getAppAttributes(id2)) == null ? void 0 : _a3.options) == null ? void 0 : _b.scenePath;
  }
...
class AppProxy {
  constructor(params, manager, appId, isAddApp) {
    ...
    this.getAppInitState = (id2) => {
      ...
      const maximized = (_a4 = this.store.getMaximized()) == null ? void 0 : _a4.includes(id2);
      const minimized = (_b = this.store.getMinimized()) == null ? void 0 : _b.includes(id2);
    ...
    this.appAttributesUpdateListener = (appId2) => {
      ...
      this.manager.refresher.add(this.stateKey, () => {
        return autorun(() => {
          var _a4, _b, _c, _d;
          const appState = (_a4 = this.appAttributes) == null ? void 0 : _a4.state;
      ...
      this.manager.refresher.add(`${appId2}-fullPath`, () => {
        return autorun(() => {
          var _a4;
          const fullPath = (_a4 = this.appAttributes) == null ? void 0 : _a4.fullPath;
    ...
    this.setFocusScenePathHandler = debounce((fullPath) => {
      var _a4;
      if (this.view && fullPath && fullPath !== ((_a4 = this.view) == null ? void 0 : _a4.focusScenePath)) {
    ...
    this.initScenes();
    if ((_a3 = this.params.options) == null ? void 0 : _a3.scenePath) {
      this.createView();
    }
  ...
  initScenes() {
    ...
    if (options) {
      ...
      if (((_a3 = this.appAttributes) == null ? void 0 : _a3.isDynamicPPT) && this.scenePath) {
  ...
  get viewIndex() {
    var _a3;
    return (_a3 = this.view) == null ? void 0 : _a3.focusSceneIndex;
  }
  get isWritable() {
    var _a3;
    return this.manager.canOperate && !((_a3 = this.box) == null ? void 0 : _a3.readonly);
  }
  get attributes() {
  ...
  async baseInsertApp(skipUpdate = false) {
    ...
    const appImpl = await ((_a3 = appRegister.appClasses.get(params.kind)) == null ? void 0 : _a3());
  ...
  get box() {
    var _a3;
    return (_a3 = this.boxManager) == null ? void 0 : _a3.getBox(this.id);
  }
  async setupApp(appId, skipUpdate, app, options, appOptions) {
    ...
    try {
      ...
      const hasHeader = (options == null ? void 0 : options.hasHeader) === false ? false : ((_a3 = this.appAttributes.options) == null ? void 0 : _a3.hasHeader) === false ? false : ((_b = this.appAttributes.state) == null ? void 0 : _b.hasHeader) === false ? false : true;
      (_c = this.boxManager) == null ? void 0 : _c.createBox({
        appId,
        app,
      ...
      const data = this.store.attributes[Fields.MainViewBackgroundInfo];
  ...
  fixMobileSize() {
    var _a3, _b;
    const box = (_a3 = this.boxManager) == null ? void 0 : _a3.getBox(this.id);
    if (box) {
  ...
  afterSetupApp(boxInitState) {
    ...
    if (boxInitState) {
      if (!(boxInitState == null ? void 0 : boxInitState.x) || !boxInitState.y) {
        (_a3 = this.boxManager) == null ? void 0 : _a3.setBoxInitState(this.id);
      }
    }
  }
  async onSeek(time2) {
    ...
    (_a3 = this.boxManager) == null ? void 0 : _a3.updateBoxState(boxInitState);
  }
  async onReconnected() {
    var _a3;
    ...
    (_a3 = this.boxManager) == null ? void 0 : _a3.updateBoxState(currentAppState);
  }
  ...
  makeAppEventListener(appId) {
    return (eventName, data) => {
      ...
      switch (eventName) {
        case "setBoxSize": {
          (_a3 = this.boxManager) == null ? void 0 : _a3.resizeBox({
            appId,
            width: data.width,
            height: data.height,
            skipUpdate: false
  ...
  async destroy(needCloseBox, cleanAttrs, skipUpdate, error) {
    ...
    if (needCloseBox) {
      (_a3 = this.boxManager) == null ? void 0 : _a3.closeBox(this.id, skipUpdate);
    }
    if (cleanAttrs) {
...
class MainViewProxy {
  ...
  async mainViewClickHandler() {
    ...
    (_a3 = this.manager.boxManager) == null ? void 0 : _a3.blurAllBox();
  }
  addCameraListener() {
...
class AppManager {
  constructor(windowManger) {
    ...
    this.onRemoveScenes = async (params) => {
      ...
      if (isRootDirPage(scenePath)) {
        ...
        let sceneName = (_a3 = this.callbacksNode) == null ? void 0 : _a3.scenes[nextIndex];
        if (!sceneName) {
          nextIndex = 0;
    ...
    this.removeSceneByIndex = async (index2) => {
      ...
      const scene = (_a3 = this.callbacksNode) == null ? void 0 : _a3.scenes[index2];
      setTimeout(() => {
        if (scene) {
    ...
    this.setSceneIndexWithoutSync = (index2) => {
      var _a3;
      const sceneName = (_a3 = this.callbacksNode) == null ? void 0 : _a3.scenes[index2];
      if (sceneName) {
    ...
    this.onFocusChange = (focused) => {
      ...
      if (this._prevFocused !== focused) {
        ...
        if (focused !== void 0) {
          (_a3 = this.boxManager) == null ? void 0 : _a3.focusBox({ appId: focused });
          setTimeout(() => {
    ...
    this.onMinimized = (minimized) => {
      var _a3, _b;
      if (((_a3 = this.boxManager) == null ? void 0 : _a3.minimized) !== minimized) {
        if (minimized === true) {
          (_b = this.boxManager) == null ? void 0 : _b.blurAllBox();
        }
        setTimeout(() => {
          var _a4;
          (_a4 = this.boxManager) == null ? void 0 : _a4.setMinimized(Boolean(minimized));
        }, 0);
      }
    };
    ...
    this.displayerWritableListener = (isReadonly) => {
      ...
      if (this.windowManger.readonly === void 0) {
        (_a3 = this.boxManager) == null ? void 0 : _a3.setReadonly(isReadonly);
      } else {
    ...
    this.sideEffectManager.addDisposer(() => {
      ...
      (_a3 = this.boxManager) == null ? void 0 : _a3.destroy();
  ...
  getMemberState() {
    var _a3;
    return ((_a3 = this.room) == null ? void 0 : _a3.state.memberState) || { strokeColor: [0, 0, 0] };
  }
  ...
  get uid() {
    var _a3;
    return ((_a3 = this.room) == null ? void 0 : _a3.uid) || "";
  }
  getMainViewSceneDir() {
    const scenePath = this.store.getMainViewScenePath();
    if (scenePath) {
  ...
  async onCreated() {
    ...
    this.displayerWritableListener(!((_a3 = this.room) == null ? void 0 : _a3.isWritable));
  ...
  setMainViewFocusPath(scenePath) {
    ...
    if (focusScenePath) {
      ...
      return ((_a3 = this.mainView) == null ? void 0 : _a3.focusScenePath) === focusScenePath;
    }
  }
  ...
  async beforeAddApp(params, isDynamicPPT) {
    ...
    const attrs = (_a3 = params.attributes) != null ? _a3 : {};
  ...
  afterAddApp(appProxy) {
    ...
    if ((_a3 = this.boxManager) == null ? void 0 : _a3.minimized) {
  ...
  getAppInitPath(appId) {
    ...
    if (attrs) {
      return (_a3 = attrs == null ? void 0 : attrs.options) == null ? void 0 : _a3.scenePath;
    }
  }
  ...
  focusByAttributes(apps) {
    var _a3;
    if (apps && Object.keys(apps).length === ((_a3 = this.boxManager) == null ? void 0 : _a3.boxSize)) {
...
const setupWrapper = (root) => {
  ...
  mainViewScrollWrapper.classList.toggle("netless-window-manager-fancy-scrollbar-readonly", Boolean(isAndroid$1() || isIOS$1()));
...
const findMemberByUid = (room, uid) => {
  ...
  for (const member of roomMembers) {
    if (((_a3 = member.payload) == null ? void 0 : _a3.uid) === uid && maxMemberId < member.memberId) {
...
class ContainerResizeObserver {
  ...
  observePlaygroundSize(container, sizer, wrapper) {
    ...
    this.containerResizeObserver = new ResizeObserver$3((entries) => {
      var _a3;
      const containerRect = (_a3 = entries[0]) == null ? void 0 : _a3.contentRect;
      if (containerRect) {
  ...
  disconnect() {
    var _a3;
    (_a3 = this.containerResizeObserver) == null ? void 0 : _a3.disconnect();
...
class Cursor {
  constructor(manager, memberId, cursorManager, wrapper) {
    ...
    this.move = (position) => {
      ...
      if (position.type === "main") {
        ...
        const viewRect = (_a3 = focusView == null ? void 0 : focusView.divElement) == null ? void 0 : _a3.getBoundingClientRect();
  ...
  moveCursor(cursor, rect, view) {
    ...
    if (point) {
      ...
      if (point.x < 0 || point.x > rect.width || point.y < 0 || point.y > rect.height) {
        (_a3 = this.component) == null ? void 0 : _a3.$set({ visible: false, x: translateX, y: translateY });
      } else {
  ...
  get memberApplianceName() {
    var _a3, _b;
    return (_b = (_a3 = this.member) == null ? void 0 : _a3.memberState) == null ? void 0 : _b.currentApplianceName;
  }
  get memberColor() {
    var _a3, _b;
    const rgb = (_b = (_a3 = this.member) == null ? void 0 : _a3.memberState) == null ? void 0 : _b.strokeColor.join(",");
    return `rgb(${rgb})`;
  }
  get memberColorHex() {
    var _a3, _b;
    const [r2, g2, b2] = ((_b = (_a3 = this.member) == null ? void 0 : _a3.memberState) == null ? void 0 : _b.strokeColor) || [236, 52, 85];
    return ((1 << 24) + (r2 << 16) + (g2 << 8) + b2).toString(16).slice(1);
  }
  get payload() {
    var _a3;
    return (_a3 = this.member) == null ? void 0 : _a3.payload;
  }
  get memberCursorName() {
    var _a3, _b;
    return ((_a3 = this.payload) == null ? void 0 : _a3.nickName) || ((_b = this.payload) == null ? void 0 : _b.cursorName) || this.memberId;
  }
  get memberTheme() {
    var _a3;
    if ((_a3 = this.payload) == null ? void 0 : _a3.theme) {
  ...
  get memberCursorTextColor() {
    var _a3;
    return ((_a3 = this.payload) == null ? void 0 : _a3.cursorTextColor) || "#FFFFFF";
  }
  get memberCursorTagBackgroundColor() {
    var _a3;
    return ((_a3 = this.payload) == null ? void 0 : _a3.cursorTagBackgroundColor) || this.memberColor;
  }
  get memberAvatar() {
    var _a3;
    return (_a3 = this.payload) == null ? void 0 : _a3.avatar;
  }
  get memberOpacity() {
  ...
  get memberTagName() {
    var _a3;
    return (_a3 = this.payload) == null ? void 0 : _a3.cursorTagName;
  }
  autoHidden() {
    if (this.timer) {
  ...
  initProps() {
    ...
    return {
      ...
      pencilEraserSize: (_a3 = this.member) == null ? void 0 : _a3.memberState.pencilEraserSize
    };
  }
  getIcon() {
    var _a3;
    ...
    if (iconsKey === ApplianceNames.pencilEraser) {
      iconsKey = `${iconsKey}${((_a3 = this.member) == null ? void 0 : _a3.memberState.pencilEraserSize) || 1}`;
    }
  ...
  updateComponent() {
    var _a3;
    (_a3 = this.component) == null ? void 0 : _a3.$set(omit(this.initProps(), ["x", "y"]));
  }
  destroy() {
    if (this.component) {
...
class CursorManager {
  constructor(manager, enableCursor, cursorOptions, applianceIcons) {
    ...
    this.getPoint = (view, clientX, clientY) => {
      var _a4;
      const rect = (_a4 = view == null ? void 0 : view.divElement) == null ? void 0 : _a4.getBoundingClientRect();
      if (rect) {
    ...
    this.getType = (event) => {
      ...
      switch (target.parentElement) {
        ...
        case ((_a4 = focusApp == null ? void 0 : focusApp.view) == null ? void 0 : _a4.divElement): {
          return { type: "app" };
        }
        default: {
          return { type: "main" };
    ...
    this.roomMembers = (_a3 = this.manager.room) == null ? void 0 : _a3.state.roomMembers;
  ...
  get focusView() {
    var _a3;
    return (_a3 = this.manager.focusApp) == null ? void 0 : _a3.view;
  }
  ...
  updateContainerRect() {
    var _a3, _b;
    this.containerRect = (_a3 = WindowManager.container) == null ? void 0 : _a3.getBoundingClientRect();
...
class ReconnectRefresher {
  constructor(ctx) {
    ...
    this.onPhaseChanged = async (phase) => {
      ...
      if (phase === RoomPhase.Connected && this.phase === RoomPhase.Reconnecting) {
        if ((_a3 = this.room) == null ? void 0 : _a3.isWritable) {
  ...
  destroy() {
    var _a3, _b;
    (_a3 = this.room) == null ? void 0 : _a3.callbacks.off("onPhaseChanged", this.onPhaseChanged);
...
const delegateRemoveScenes = (room, manager) => {
  ...
  room.removeScenes = (scenePath, index2) => {
    var _a3;
    if (scenePath === ROOT_DIR) {
      (_a3 = manager.appManager) == null ? void 0 : _a3.updateRootDirRemoving(true);
    }
...
var DOMRectReadOnly = function() {
  ...
  DOMRectReadOnly2.prototype.toJSON = function() {
    var _a22 = this, x2 = _a22.x, y2 = _a22.y, top = _a22.top, right = _a22.right, bottom = _a22.bottom, left = _a22.left, width = _a22.width, height = _a22.height;
...
var isHidden = function(target) {
  if (isSVG(target)) {
    var _a22 = target.getBBox(), width = _a22.width, height = _a22.height;
    return !width && !height;
  }
...
var isElement = function(obj) {
  ...
  var scope = (_a22 = obj === null || obj === void 0 ? void 0 : obj.ownerDocument) === null || _a22 === void 0 ? void 0 : _a22.defaultView;
...
var calculateBoxSize = function(target, observedBox, forceRecalculation) {
  var _a22 = calculateBoxSizes(target, forceRecalculation), borderBoxSize = _a22.borderBoxSize, contentBoxSize = _a22.contentBoxSize, devicePixelContentBoxSize = _a22.devicePixelContentBoxSize;
  switch (observedBox) {
...
class DocsViewer {
  ...
  scrollPreview(pageIndex) {
    var _a22;
    const previews = (_a22 = this.$preview) == null ? void 0 : _a22.querySelectorAll(
      "." + this.wrapClassName("preview-page")
    );
    previews == null ? void 0 : previews.forEach((node, i2) => {
      var _a3;
      (_a3 = node.querySelector("img")) == null ? void 0 : _a3.classList.toggle(this.wrapClassName("active"), Number(pageIndex) == i2);
    });
    if (!previews)
      return;
  ...
  renderPreview() {
    if (!this.$preview) {
      ...
      this.pages.forEach((page, i2) => {
        var _a22;
        const previewSRC = (_a22 = page.thumbnail) != null ? _a22 : page.src.startsWith("ppt") ? void 0 : page.src;
        if (!previewSRC) {
          return;
        }
      ...
      this.sideEffect.addEventListener($preview, "click", (ev) => {
        ...
        const pageIndex = (_a22 = ev.target.dataset) == null ? void 0 : _a22.pageIndex;
        if (pageIndex) {
          ev.preventDefault();
          ev.stopPropagation();
    ...
    if (!this.$footer) {
      ...
      if (this.onPlay) {
        ...
        this.sideEffect.addEventListener($btnPlay, "click", () => {
          ...
          (_a22 = this.onPlay) == null ? void 0 : _a22.call(this);
          returnPlay();
        });
  ...
  togglePreview(isShowPreview) {
    ...
    console.log((_a22 = this.context) == null ? void 0 : _a22.extendWrapper);
...
class Stepper {
  constructor(config) {
    ...
    this.current = (_a22 = config.start) != null ? _a22 : 0;
...
const ResizeObserver$2 = window.ResizeObserver || ResizeObserver$1;
...
class StaticDocsViewer {
  ...
  mount() {
    ...
    this.sideEffect.add(() => {
      const observer = new ResizeObserver$2(debouncedRenderRatioHeight);
  ...
  jumpToPage(index2, reset) {
    ...
    if (index2 !== this.getPageIndex()) {
      if (this.context.getIsWritable()) {
        ...
        const scene = (_b = (_a22 = this.context.getScenes()) == null ? void 0 : _a22[index2]) == null ? void 0 : _b.name;
    ...
    this.sideEffect.addEventListener(window, "keydown", (ev) => {
      ...
      if (this.box.focus && !isEditable(ev.target)) {
        switch (ev.key) {
          ...
          case "ArrowRight":
          case "ArrowDown": {
            (_a22 = this.context.getRoom()) == null ? void 0 : _a22.pptNextStep();
            break;
          }
        }
      }
      ...
      this.sideEffect.addEventListener(this.$whiteboardView, "click", (ev) => {
        ...
        if (room && room.state.memberState.currentApplianceName === "clicker") {
          for (let el = ev.target; el; el = el.parentElement) {
            if ((_a22 = el.classList) == null ? void 0 : _a22.contains("ppt-event-source")) {
              return;
            }
          }
          room.pptNextStep();
...
function setupStaticDocsViewer(context, whiteboardView, box, pages) {
  ...
  const docsViewer = new StaticDocsViewer({
    ...
    box,
    pages,
    pageScrollTop: (_a22 = context.getAttributes()) == null ? void 0 : _a22.pageScrollTop,
...
const _IframeBridge = class {
    ...
    this.sideEffectManager.addDisposer(
      _IframeBridge.emitter.on("created", () => {
        ...
        this.bridgeDisposer = autorun(() => {
          ...
          const attributes = this.attributes;
          if (attributes.url) {
            const iframeSrc = (_a3 = this.iframe) == null ? void 0 : _a3.src;
    ...
    const loadListener = (ev) => {
      ...
      this.postMessage({
        ...
        payload: {
          ...
          roomState: (_a3 = _IframeBridge.displayer) == null ? void 0 : _a3.state,
      ...
      this.sideEffectManager.addDisposer(
        _IframeBridge.emitter.on("Ready", () => {
          var _a4;
          this.postMessage((_a4 = this.attributes.lastEvent) == null ? void 0 : _a4.payload);
        }),
        RefreshIDs.Ready
      );
      this.computedStyleAndIframeDisplay();
  ...
  postMessage(message) {
    var _a3;
    if (this.iframe) {
      (_a3 = this.iframe.contentWindow) == null ? void 0 : _a3.postMessage(JSON.parse(JSON.stringify(message)), "*");
    }
  }
...
function createCallbackManager() {
  let callbacks2 = /* @__PURE__ */ new Set();
  function addCallback(cb2) {
    callbacks2.add(cb2);
    return () => {
      removeCallback(cb2);
    };
  }
  function removeCallback(cb2) {
    callbacks2.delete(cb2);
  }
  ...
  function hasCallbacks() {
    return Boolean(callbacks2.size);
  }
  function removeAll() {
    callbacks2 = /* @__PURE__ */ new Set();
  }
  return {
    runCallbacks,
    addCallback,
...
class ViewScroller {
  constructor(config) {
    this.baseScrollTop = 0;
    this.baseScrollLeft = 0;
    this._isInternalUpdate = false;
    this._isRemoteSync = false;
    this.updateSize = () => {
      this.baseScrollTop = this._scrollingElement.scrollHeight - this._scrollingElement.clientHeight;
      this.baseScrollLeft = this._scrollingElement.scrollWidth - this._scrollingElement.clientWidth;
      this.scroll();
    };
    this.dispatchScrollEvent = debounce(({ x: x2, y: y2 }) => {
      var _a3, _b, _c, _d;
      console.log(`${logFirstTag} ViewScrollChange Dispatch Scroll Event`, { appId: this.appId, x: x2, y: y2 });
      const currentData = (_b = (_a3 = this.manager.appManager) == null ? void 0 : _a3.store) == null ? void 0 : _b.getViewScrollChange();
      if (currentData && currentData.appId === this.appId && Math.abs(currentData.x - x2) < 0.01 && Math.abs(currentData.y - y2) < 0.01) {
        console.log(`${logFirstTag} ViewScrollChange Skip - No significant change`);
        return;
      }
      (_d = (_c = this.manager.appManager) == null ? void 0 : _c.store) == null ? void 0 : _d.setViewScrollChange({ appId: this.appId, x: x2, y: y2 });
    }, 200);
    this._sideEffect = new o$2();
    const { createVal } = createSideEffectBinder(this._sideEffect);
    this._scrollingElement = config.scrollElement;
    this.manager = config.manager;
    this.appId = config.appId;
    this.crood = createVal(this.getAttribute());
    const valConfig = {
      $crood: this.crood
    };
  ...
  onScroll() {
    ...
    if (this._isInternalUpdate)
      return;
    if (this._isRemoteSync)
      return;
    const { x: x2, y: y2 } = this.calcLocalToCoord(this.getLocalCoord());
    this.dispatchScrollEvent({ x: x2, y: y2 });
  }
  scroll() {
  ...
  getAttribute() {
    var _a3, _b;
    const currentAttribute = ((_b = (_a3 = this.manager.appManager) == null ? void 0 : _a3.store) == null ? void 0 : _b.getViewScrollChange()) || { x: 0, y: 0 };
...
const ScrollerScrollEventType = "windowMananerAppScrolling";
class ScrollerManager {
  ...
  onAppScrolling(payload) {
    console.log(`${logFirstTag} ScrollerManager onAppScrolling`, JSON.stringify(payload));
    if (payload) {
      const { appId, x: x2, y: y2 } = payload;
      if (appId) {
        this.scrollToFromRemote(appId, { x: x2, y: y2 });
      }
    }
  }
  add(config) {
    if (this.scrollers.find((item) => item.appId == config.appId))
      return;
    const scroller = new ViewScroller(config);
    this.scrollers.push(scroller);
  }
  scrollTo(appId, position) {
  ...
  scrollToFromRemote(appId, position) {
    const scroller = this.getScroller(appId);
  ...
  moveToCenter(appId) {
    ...
    if (appId) {
      const scroller = this.getScroller(appId);
      scroller && this.scrollTo(scroller == null ? void 0 : scroller.appId, center);
    } else {
      this.scrollers.forEach((item) => this.scrollTo(item == null ? void 0 : item.appId, center));
    }
  }
  getScroller(appId) {
    if (!appId)
...
class AllBoxStatusInfoManager {
  constructor() {
    this._sideEffect = new o$2();
    const { createVal } = createSideEffectBinder(this._sideEffect);
    this._currentAllBoxStatusInfo$ = createVal({});
    this._lastNotMinimizedBoxsStatus$ = createVal({});
  }
  get currentAllBoxStatusInfo$() {
    return this._currentAllBoxStatusInfo$;
  }
  get lastNotMinimizedBoxsStatus$() {
    return this._lastNotMinimizedBoxsStatus$;
  }
  setCurrentAllBoxStatusInfo(info, skipUpdate = false) {
    this._currentAllBoxStatusInfo$.setValue({ ...info }, skipUpdate);
  }
  resetCleanCurrentAllBoxStatusInfoFromBoxes(boxes, skipUpdate = false) {
  ...
  resetCleanLastNotMinimizedBoxsStatusFromBoxes(boxes, skipUpdate = false) {
    const allBoxIds = boxes.map((item) => item.id);
  ...
  setLastNotMinimizedBoxsStatus(info, skipUpdate = false) {
    this._lastNotMinimizedBoxsStatus$.setValue({ ...info }, skipUpdate);
  }
  setCurrentBoxState(boxId, state, skipUpdate = false) {
  ...
  setLastNotMinimizedBoxState(boxId, state, skipUpdate = false) {
  ...
  getBoxesList(type) {
    return Object.entries(this._currentAllBoxStatusInfo$.value).filter(([_2, state]) => state === type).map(([boxId]) => boxId);
  }
  hasMaximizedBox() {
...
const _WindowManager = class extends InvisiblePlugin {
  constructor(context) {
    ...
    window.NETLESS_DEPS = { "dependencies": { "@juggle/resize-observer": "^3.4.0", "@netless/telebox-insider": "github:veytu/telebox-insider#testWhite", "emittery": "^0.9.2", "lodash": "^4.17.21", "p-retry": "^4.6.2", "uuid": "^7.0.3", "value-enhancer": "0.0.8", "video.js": "^8.23.4" }, "peerDependencies": { "jspdf": "2.5.1", "white-web-sdk": "^2.16.52" }, "devDependencies": { "@hyrious/dts": "^0.2.11", "@netless/app-docs-viewer": "github:veytu/app-docs-viewer", "@netless/app-media-player": "0.1.4", "@rollup/plugin-commonjs": "^20.0.0", "@rollup/plugin-node-resolve": "^13.3.0", "@rollup/plugin-url": "^6.1.0", "@sveltejs/vite-plugin-svelte": "1.0.0-next.40", "@tsconfig/svelte": "^2.0.1", "@types/debug": "^4.1.12", "@types/lodash": "^4.17.20", "@types/lodash-es": "^4.17.12", "@types/uuid": "^8.3.4", "@typescript-eslint/eslint-plugin": "^4.33.0", "@typescript-eslint/parser": "^4.33.0", "@vitest/ui": "^0.14.2", "cypress": "^8.7.0", "dotenv": "^10.0.0", "eslint": "^7.32.0", "eslint-config-prettier": "^8.10.2", "eslint-plugin-svelte3": "^3.4.1", "jsdom": "^19.0.0", "jspdf": "^2.5.2", "less": "^4.4.1", "prettier": "^2.8.8", "prettier-plugin-svelte": "^2.10.1", "rollup-plugin-analyzer": "^4.0.0", "rollup-plugin-styles": "^3.14.1", "side-effect-manager": "0.1.5", "svelte": "^3.59.2", "typescript": "^4.9.5", "vite": "^2.9.18", "vitest": "^0.14.2", "white-web-sdk": "^2.16.53" } };
  }
  ...
  static async mount(params) {
    ...
    (_b = (_a3 = manager.appManager) == null ? void 0 : _a3.refresher) == null ? void 0 : _b.add(Fields.Scale, () => {
      ...
      return createAntiLoopAutorun(() => {
        ...
        if (keys.length > 0) {
          ...
          manager == null ? void 0 : manager._setScale({ appId, scale: currentScale }, true);
        }
      }, "Scale");
    });
    ...
    (_h = (_g = manager.appManager) == null ? void 0 : _g.refresher) == null ? void 0 : _h.add(Fields.MainViewBackgroundInfo, () => {
      console.log(`${logFirstTag} MainViewBackgroundInfo Register Listener`);
      return createAntiLoopAutorun(() => {
        const data = get(manager.appManager.attributes, Fields.MainViewBackgroundInfo);
        console.log(`${logFirstTag} MainViewBackgroundInfo Target`, JSON.stringify(data));
        if (data.img.length > 0) {
          manager == null ? void 0 : manager._setBackgroundImg(data.img);
        } else if (data.color.length > 0) {
          manager == null ? void 0 : manager._setBackgroundColor(data.color);
        }
      }, "MainViewBackgroundInfo");
    });
    (_j = (_i = manager.appManager) == null ? void 0 : _i.refresher) == null ? void 0 : _j.add(Fields.AllBoxStatusInfo, () => {
  ...
  bindContainer(container) {
    ...
    if (_WindowManager.isCreated && _WindowManager.container) {
      ...
      if (_WindowManager.params) {
        ...
        this.boxManager = boxManager;
        (_a3 = this.appManager) == null ? void 0 : _a3.setBoxManager(boxManager);
        if (_WindowManager.mainViewScrollWrapper) {
          (_b = this.scrollerManager) == null ? void 0 : _b.add({
            appId: mainViewField,
            scrollElement: _WindowManager.mainViewScrollWrapper,
            manager: this
          });
        }
        this.bindMainView(mainViewElement, params.disableCameraTransform);
        if (_WindowManager.wrapper) {
          (_c = this.cursorManager) == null ? void 0 : _c.setupWrapper(_WindowManager.wrapper);
        }
      }
    }
    internalEmitter.emit("updateManagerRect");
    ...
    _WindowManager.container = container;
    (_h = this.extendPluginManager) == null ? void 0 : _h.refreshContainer(container);
  }
  ...
  getMainViewScenePath() {
    var _a3;
    return (_a3 = this.appManager) == null ? void 0 : _a3.store.getMainViewScenePath();
  }
  getMainViewSceneIndex() {
    var _a3;
    return (_a3 = this.appManager) == null ? void 0 : _a3.store.getMainViewSceneIndex();
  }
  setReadonly(readonly) {
    var _a3;
    this.readonly = readonly;
    (_a3 = this.boxManager) == null ? void 0 : _a3.setReadonly(readonly);
    internalEmitter.emit("setReadonly", readonly);
  }
  switchMainViewToWriter() {
    var _a3;
    return (_a3 = this.appManager) == null ? void 0 : _a3.mainViewProxy.mainViewClickHandler();
  }
  ...
  setViewMode(mode) {
    ...
    if (mode === ViewMode.Broadcaster || mode === ViewMode.Follower) {
      if (this.canOperate && mode === ViewMode.Broadcaster) {
        (_a3 = this.appManager) == null ? void 0 : _a3.mainViewProxy.setCameraAndSize();
      }
  ...
  setMaximized(maximized) {
    ...
    if (!this.canOperate)
      return;
    (_a3 = this.boxManager) == null ? void 0 : _a3.setMaximized(maximized, false);
  }
  setMinimized(minimized) {
    var _a3;
    if (!this.canOperate)
      return;
    (_a3 = this.boxManager) == null ? void 0 : _a3.setMinimized(minimized, false);
  }
  setFullscreen(fullscreen) {
    var _a3;
    if (this._fullscreen !== fullscreen) {
      this._fullscreen = fullscreen;
      (_a3 = _WindowManager.sizer) == null ? void 0 : _a3.classList.toggle("netless-window-manager-fullscreen", fullscreen);
  ...
  setCursorUIDs(cursorUIDs) {
    ...
    if (this._cursorUIDs.length === 0) {
      (_a3 = this._cursorUIDsStyleDOM) == null ? void 0 : _a3.remove();
    } else {
...
[data-cursor-uid="${uid}"] { display: flex }`;
  ...
  maximizedBoxNextPage() {
    ...
    if (!boxId)
      return false;
    const box = (_a3 = this.appManager) == null ? void 0 : _a3.appProxies.get(boxId);
    if (!box)
      return false;
  ...
  get apps() {
    var _a3;
    return (_a3 = this.appManager) == null ? void 0 : _a3.store.apps();
  }
  get boxState() {
    var _a3;
    if (this.appManager) {
      return (_a3 = this.appManager.boxManager) == null ? void 0 : _a3.boxState;
    } else {
      throw new AppManagerNotInitError();
    }
  }
  get darkMode() {
    var _a3, _b;
    return Boolean((_b = (_a3 = this.appManager) == null ? void 0 : _a3.boxManager) == null ? void 0 : _b.darkMode);
  }
  get prefersColorScheme() {
    var _a3;
    if (this.appManager) {
      return (_a3 = this.appManager.boxManager) == null ? void 0 : _a3.prefersColorScheme;
    } else {
      throw new AppManagerNotInitError();
    }
  }
  ...
  get focusedView() {
    var _a3, _b;
    return ((_b = (_a3 = this.appManager) == null ? void 0 : _a3.focusApp) == null ? void 0 : _b.view) || this.mainView;
  }
  get polling() {
    var _a3;
    return ((_a3 = this.appManager) == null ? void 0 : _a3.polling) || false;
  }
  set polling(b2) {
    if (this.appManager) {
  ...
  get cursorStyle() {
    var _a3;
    return ((_a3 = this.cursorManager) == null ? void 0 : _a3.style) || "default";
  }
  ...
  get mainViewSceneIndex() {
    var _a3;
    return ((_a3 = this._pageState) == null ? void 0 : _a3.index) || 0;
  }
  get mainViewSceneDir() {
    var _a3;
    if (this.appManager) {
      return (_a3 = this.appManager) == null ? void 0 : _a3.getMainViewSceneDir();
    } else {
      throw new AppManagerNotInitError();
    }
  }
  get topApp() {
    var _a3, _b;
    return (_b = (_a3 = this.boxManager) == null ? void 0 : _a3.getTopBox()) == null ? void 0 : _b.id;
  }
  get mainViewScenesLength() {
    var _a3;
    return ((_a3 = this._pageState) == null ? void 0 : _a3.length) || 0;
  }
  get canRedoSteps() {
    var _a3;
    return ((_a3 = this.focusedView) == null ? void 0 : _a3.canRedoSteps) || 0;
  }
  get canUndoSteps() {
    var _a3;
    return ((_a3 = this.focusedView) == null ? void 0 : _a3.canUndoSteps) || 0;
  }
  get sceneState() {
    if (this.appManager) {
  ...
  get extendWrapper() {
    return _WindowManager.extendWrapper;
  }
  queryAll() {
    var _a3;
    return Array.from(((_a3 = this.appManager) == null ? void 0 : _a3.appProxies.values()) || []);
  }
  queryOne(appId) {
    var _a3;
    return (_a3 = this.appManager) == null ? void 0 : _a3.appProxies.get(appId);
  }
  async closeApp(appId) {
    var _a3;
    return (_a3 = this.appManager) == null ? void 0 : _a3.closeApp(appId);
  }
  focusApp(appId) {
    var _a3, _b, _c;
    const box = (_a3 = this.boxManager) == null ? void 0 : _a3.getBox(appId);
    if (box) {
  ...
  moveCamera(camera) {
    ...
    (_a3 = this.appManager) == null ? void 0 : _a3.dispatchInternalEvent(Events.MoveCamera, camera);
    setTimeout(() => {
      var _a4;
      (_a4 = this.appManager) == null ? void 0 : _a4.mainViewProxy.setCameraAndSize();
    }, 500);
  }
  moveCameraToContain(rectangle) {
    var _a3;
    this.mainView.moveCameraToContain(rectangle);
    (_a3 = this.appManager) == null ? void 0 : _a3.dispatchInternalEvent(Events.MoveCameraToContain, rectangle);
    setTimeout(() => {
      var _a4;
      (_a4 = this.appManager) == null ? void 0 : _a4.mainViewProxy.setCameraAndSize();
    }, 500);
  ...
  bindMainView(divElement, disableCameraTransform) {
    ...
    if (this.appManager) {
      ...
      (_a3 = this.cursorManager) == null ? void 0 : _a3.setMainViewDivElement(divElement);
    }
  }
  get canOperate() {
    if (isRoom(this.displayer)) {
  ...
  setPrefersColorScheme(scheme) {
    var _a3, _b;
    (_b = (_a3 = this.appManager) == null ? void 0 : _a3.boxManager) == null ? void 0 : _b.setPrefersColorScheme(scheme);
  }
  cleanCurrentScene() {
    var _a3;
    log("clean current scene");
    (_a3 = this.focusedView) == null ? void 0 : _a3.cleanCurrentScene();
  }
  redo() {
    var _a3;
    return ((_a3 = this.focusedView) == null ? void 0 : _a3.redo()) || 0;
  }
  undo() {
    var _a3;
    return ((_a3 = this.focusedView) == null ? void 0 : _a3.undo()) || 0;
  }
  delete() {
    var _a3;
    (_a3 = this.focusedView) == null ? void 0 : _a3.delete();
  }
  copy() {
    var _a3;
    (_a3 = this.focusedView) == null ? void 0 : _a3.copy();
  }
  paste() {
    var _a3;
    (_a3 = this.focusedView) == null ? void 0 : _a3.paste();
  }
  duplicate() {
    var _a3;
    (_a3 = this.focusedView) == null ? void 0 : _a3.duplicate();
  }
  insertText(x2, y2, text2) {
    var _a3;
    return ((_a3 = this.focusedView) == null ? void 0 : _a3.insertText(x2, y2, text2)) || "";
  }
  insertImage(info) {
    var _a3;
    return (_a3 = this.focusedView) == null ? void 0 : _a3.insertImage(info);
  }
  completeImageUpload(uuid, url) {
    var _a3;
    return (_a3 = this.focusedView) == null ? void 0 : _a3.completeImageUpload(uuid, url);
  }
  lockImage(uuid, locked) {
    var _a3;
    return (_a3 = this.focusedView) == null ? void 0 : _a3.lockImage(uuid, locked);
  }
  lockImages(locked) {
    var _a3;
    return (_a3 = this.focusedView) == null ? void 0 : _a3.lockImages(locked);
  }
  refresh() {
    var _a3;
    this._refresh();
    (_a3 = this.appManager) == null ? void 0 : _a3.dispatchInternalEvent(Events.Refresh);
  }
  _refresh() {
    var _a3, _b;
    (_a3 = this.appManager) == null ? void 0 : _a3.mainViewProxy.rebind();
    if (_WindowManager.container) {
  ...
  setScale(appId, scale2) {
    ...
    const currentScale = (_a3 = this.getScale()) == null ? void 0 : _a3[appId];
  ...
  _updateMainViewWrapperSize(scale2, skipEmit) {
    var _a3;
  ...
  _setScale(data, skipEmit) {
    var _a3;
    const { appId, scale: scale2 } = data;
    if (appId == mainViewField) {
      this._updateMainViewWrapperSize(scale2, skipEmit);
    } else {
      internalEmitter.emit("onScaleChange", { appId, scale: scale2 });
    }
    (_a3 = this.scrollerManager) == null ? void 0 : _a3.moveToCenter(appId);
    return true;
  }
  getScale() {
  ...
  setTeacherInfo(data) {
    var _a3, _b;
    (_b = (_a3 = this.appManager) == null ? void 0 : _a3.store) == null ? void 0 : _b.setTeacherInfo(data);
  }
  get teacherInfo() {
    var _a3, _b;
    return ((_b = (_a3 = this.appManager) == null ? void 0 : _a3.store) == null ? void 0 : _b.getTeacherInfo()) || {};
  }
  setLaserPointer(active) {
    var _a3;
  ...
  async _setLaserPointer(active) {
    ...
    if (!active) {
      ...
      cursorNode == null ? void 0 : cursorNode.forEach((i2) => {
        i2.classList.add("force-none");
      });
      return;
    }
  ...
  _getCurrentUserId() {
    var _a3, _b, _c, _d;
    return ((_a3 = this.appManager) == null ? void 0 : _a3.uid) ? (_d = (_c = findMemberByUid(this.room, (_b = this.appManager) == null ? void 0 : _b.uid)) == null ? void 0 : _c.payload) == null ? void 0 : _d.uid : void 0;
  }
  ...
  isDynamicPPT(scenes) {
    var _a3, _b;
    const sceneSrc = (_b = (_a3 = scenes[0]) == null ? void 0 : _a3.ppt) == null ? void 0 : _b.src;
  ...
  useExtendPlugin(extend) {
    var _a3;
    (_a3 = this.extendPluginManager) == null ? void 0 : _a3.use(extend);
  }
  getBackground() {
    if (!!this.attributes[Fields.MainViewBackgroundInfo]) {
  ...
  setBackgroundColor(color2) {
    this.safeUpdateAttributes([Fields.MainViewBackgroundInfo], { color: color2, img: "" });
  }
  _setBackgroundColor(color2) {
    if (!_WindowManager.mainViewWrapper)
      return;
    _WindowManager.mainViewWrapper.style.backgroundColor = color2;
    _WindowManager.mainViewWrapper.style.backgroundImage = "unset";
  }
  _setBackgroundImg(src) {
    if (!_WindowManager.mainViewWrapper)
      return;
    _WindowManager.mainViewWrapper.style.backgroundImage = `url(${src})`;
    _WindowManager.mainViewWrapper.style.backgroundColor = "unset";
  }
  _initAttribute() {
    const data = this.attributes[Fields.MainViewBackgroundInfo];
    if (data && data.img.length > 0) {
    ...
    if (!!this.attributes[Fields.Scale]) {
      const scaleMap = this.attributes[Fields.Scale];
...
setupBuiltin();
export { AllBoxStatusInfoManager, AppCreateError, AppManagerNotInitError, AppNotRegisterError, BindContainerRoomPhaseInvalidError, BoxManagerNotFoundError, BoxNotCreatedError, BuiltinApps, DomEvents, ExtendPlugin, ExtendPluginManager, IframeBridge, IframeEvents, InvalidScenePath, LaserPointerManager, LaserPointerMultiManager, ParamsInvalidError, WhiteWebSDKInvalidError, WindowManager, WukongRoleManager, WukongUserRoleType, calculateNextIndex, logFirstTag, mainViewField, reconnectRefresher };
