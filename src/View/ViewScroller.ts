...
class ViewScroller {
    ...
    private onScroll() {
        console.log('window manager scroll readonly', this.manager.readonly || !WindowManager.wukongRoleManager?.wukongCanOperate())
        if (this.manager.readonly || !WindowManager.wukongRoleManager?.wukongCanOperate()) return
