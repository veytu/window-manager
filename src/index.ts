    ...
    implements PageController
{
    ...
    private _setLaserPointer(active: boolean) {
        ...
        if (!this.mutationObserver) {
            this.mutationObserver = new MutationObserver((mutationsList) => {
                for (let mutation of mutationsList) {
                    if (mutation.type === "childList") {
                        ...
                        const clickImg: HTMLImageElement | null | undefined = WindowManager.wrapper?.querySelector('.netless-window-manager-cursor-clicker-image')
            ...
            this.mutationObserver.observe(WindowManager.wrapper, { subtree: true, childList: true });
        }
    }
